...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ea(e,t,n){let r=new Float32Array(Bi),i=new H(0,1,0);return new Cr({name:`SphericalGaussianBlur`,defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ra(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ta(){return new Cr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ra(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function na(){return new Cr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ra(),fragmentShader:`
	...
	`}var ia=class extends Je{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new cr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ao={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function jo(e,t){let n=Ao[t];return n===void 0?(P(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Mo=new H;function No(){return q.getLuminanceCoefficients(Mo),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Mo.x.toFixed(4)}, ${Mo.y.toFixed(4)}, ${Mo.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=So(i,i.VERTEX_SHADER,y),S=So(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Oo(i,x,`vertex`),n=Oo(i,S,`fragment`);F(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,$s=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="10 10 80 80"><g fill="currentColor"><circle r="10" cx="20" cy="20"/><circle r="10" cx="50" cy="20"/><circle r="10" cx="80" cy="20"/><circle r="10" cx="20" cy="50"/><circle r="10" cx="50" cy="50"/><circle r="10" cx="80" cy="50"/><circle r="10" cx="20" cy="80"/><circle r="10" cx="50" cy="80"/><circle r="10" cx="80" cy="80"/></g><!-- Created by Richard Kunák from the Noun Project--></svg>
`,ec=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill="currentColor" d="M14.043 12.22a7.738 7.738 0 1 0-1.823 1.822l4.985 4.985c.503.504 1.32.504 1.822 0a1.285 1.285 0 0 0 0-1.822l-4.984-4.985zm-6.305 1.043a5.527 5.527 0 1 1 0-11.053 5.527 5.527 0 0 1 0 11.053z"/><path fill="currentColor" d="M8.728 4.009H6.744v2.737H4.006V8.73h2.738v2.736h1.984V8.73h2.737V6.746H8.728z"/><!--Created by Ryan Canning from the Noun Project--></svg>
...
`,nc=500,rc=4,ic=300,ac=500,oc=100,sc=2e3,cc=10,lc=`photoSphereViewer`,uc=`psv--capture-event`,dc=(e=>(e.ROTATE_UP=`ROTATE_UP`,e.ROTATE_DOWN=`ROTATE_DOWN`,e.ROTATE_RIGHT=`ROTATE_RIGHT`,e.ROTATE_LEFT=`ROTATE_LEFT`,e.ZOOM_IN=`ZOOM_IN`,e.ZOOM_OUT=`ZOOM_OUT`,e))(dc||{}),fc={MENU:`menu`,TWO_FINGERS:`twoFingers`,CTRL_ZOOM:`ctrlZoom`,ERROR:`error`,DESCRIPTION:`description`},pc={Enter:`Enter`,Control:`Control`,Escape:`Escape`,Space:` `,PageUp:`PageUp`,PageDown:`PageDown`,ArrowLeft:`ArrowLeft`,ArrowUp:`ArrowUp`,ArrowRight:`ArrowRight`,ArrowDown:`ArrowDown`,Delete:`Delete`,Plus:`+`,Minus:`-`},mc={arrow:qs,close:Js,download:Ys,fullscreenIn:Xs,fullscreenOut:Zs,info:Qs,menu:$s,zoomIn:ec,zoomOut:tc},hc={linear:e=>e,inQuad:e=>e*e,outQuad:e=>e*(2-e),inOutQuad:e=>e<.5?2*e*e:-1+(4-2*e)*e,inCubic:e=>e*e*e,outCubic:e=>--e*e*e+1,inOutCubic:e=>e<.5?4*e*e*e:(e-1)*(2*e-2)*(2*e-2)+1,inQuart:e=>e*e*e*e,outQuart:e=>1- --e*e*e*e,inOutQuart:e=>e<.5?8*e*e*e*e:1-8*--e*e*e*e,inQuint:e=>e*e*e*e*e,outQuint:e=>1+--e*e*e*e*e,inOutQuint:e=>e<.5?16*e*e*e*e*e:1+16*--e*e*e*e*e,inSine:e=>1-Math.cos(Math.PI/2*e),outSine:e=>Math.sin(Math.PI/2*e),inOutSine:e=>.5-.5*Math.cos(Math.PI*e),inExpo:e=>2**(10*(e-1)),outExpo:e=>1-2**(-10*e),inOutExpo:e=>(e=e*2-1)<0?.5*2**(10*e):1-.5*2**(-10*e),inCirc:e=>1-Math.sqrt(1-e*e),outCirc:e=>Math.sqrt(1-(e-1)*(e-1)),inOutCirc:e=>(e*=2)<1?.5-.5*Math.sqrt(1-e*e):.5+.5*Math.sqrt(1-(e-=2)*e)},gc={};Gs(gc,{Animation:()=>Ol,Dynamic:()=>kl,MultiDynamic:()=>Al,PressHandler:()=>jl,Slider:()=>Nl,SliderDirection:()=>Ml,addClasses:()=>Ec,angle:()=>bc,applyEulerInverse:()=>Dl,checkClosedShadowDom:()=>_l,checkStylesheet:()=>hl,checkVersion:()=>gl,cleanCssPosition:()=>ll,clone:()=>Wc,createSizedTexture:()=>Tl,createTexture:()=>wl,cssPositionIsOrdered:()=>ul,dasherize:()=>Bc,deepEqual:()=>Jc,deepmerge:()=>Uc,distance:()=>yc,exitFullscreen:()=>Rc,firstNonNull:()=>qc,getAbortError:()=>Qc,getAngle:()=>Sc,getClosest:()=>kc,getConfigParser:()=>ml,getElement:()=>wc,getEventTarget:()=>Ac,getMatchingTarget:()=>jc,getPosition:()=>Mc,getShortestArc:()=>xc,getStyleProperty:()=>Nc,getTouchData:()=>Pc,getXMPValue:()=>nl,greatArcDistance:()=>Cc,hasParent:()=>Oc,invertResolvableBoolean:()=>Zc,isAbortError:()=>$c,isEmpty:()=>Gc,isExtendedPosition:()=>tl,isFullscreenEnabled:()=>Ic,isNil:()=>Kc,isPlainObject:()=>Hc,keyPressMatch:()=>zc,logWarn:()=>el,mergePanoData:()=>vl,parseAngle:()=>pl,parsePoint:()=>cl,parseSpeed:()=>dl,removeClasses:()=>Dc,requestFullscreen:()=>Lc,resolveBoolean:()=>Xc,speedToDuration:()=>fl,sum:()=>vc,throttle:()=>Vc,toggleClass:()=>Tc,wrap:()=>_c});function _c(e,t){let n=e%t;return n<0&&(n+=t),n}function vc(e){return e.reduce((e,t)=>e+t,0)}function yc(e,t){return Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2)}function bc(e,t){return Math.atan2(t.y-e.y,t.x-e.x)}function xc(e,t){return[0,Math.PI*2,-Math.PI*2].reduce((n,r)=>{let i=t-e+r;return Math.abs(i)<Math.abs(n)?i:n},1/0)}function Sc(e,t){return Math.acos(Math.cos(e.pitch)*Math.cos(t.pitch)*Math.cos(e.yaw-t.yaw)+Math.sin(e.pitch)*Math.sin(t.pitch))}function Cc([e,t],[n,r]){e-n>Math.PI?e-=2*Math.PI:e-n<-Math.PI&&(e+=2*Math.PI);let i=(n-e)*Math.cos((t+r)/2),a=r-t;return Math.sqrt(i*i+a*a)}function wc(e){return typeof e==`string`?e.match(/^[a-z]/i)?document.getElementById(e):document.querySelector(e):e}function Tc(e,t,n){n===void 0?e.classList.toggle(t):n?e.classList.add(t):n||e.classList.remove(t)}function Ec(e,t){e.classList.add(...t.split(` `).filter(e=>!!e))}function Dc(e,t){e.classList.remove(...t.split(` `).filter(e=>!!e))}function Oc(e,t){let n=e;do{if(n===t)return!0;n=n.parentElement}while(n);return!1}function kc(e,t){if(!e?.matches)return null;let n=e;do{if(n.matches(t))return n;n=n.parentElement}while(n);return null}function Ac(e){return e?.composedPath()[0]||null}function jc(e,t){return e?e.composedPath().find(e=>!(e instanceof HTMLElement)&&!(e instanceof SVGElement)?!1:e.matches(t)):null}function Mc(e){let t=0,n=0,r=e;for(;r;)t+=r.offsetLeft-r.scrollLeft+r.clientLeft,n+=r.offsetTop-r.scrollTop+r.clientTop,r=r.offsetParent;return t-=window.scrollX,n-=window.scrollY,{x:t,y:n}}function Nc(e,t){return window.getComputedStyle(e).getPropertyValue(t)}function Pc(e){if(e.touches.length<2)return null;let t={x:e.touches[0].clientX,y:e.touches[0].clientY},n={x:e.touches[1].clientX,y:e.touches[1].clientY};return{distance:yc(t,n),angle:bc(t,n),center:{x:(t.x+n.x)/2,y:(t.y+n.y)/2}}}var Fc;function Ic(e,t=!1){return t?e===Fc:document.fullscreenElement===e}function Lc(e,t=!1){t?(Fc=e,e.classList.add(`psv-fullscreen-emulation`),document.dispatchEvent(new Event(`fullscreenchange`))):e.requestFullscreen()}function Rc(e=!1){e?(Fc.classList.remove(`psv-fullscreen-emulation`),Fc=null,document.dispatchEvent(new Event(`fullscreenchange`))):document.exitFullscreen()}function zc(e,t){let n,r=!1,i=!1,a=!1,o=!1;return t===`+`?n=t:t.split(`+`).forEach(e=>{switch(e){case`Shift`:r=!0;break;case`Ctrl`:i=!0;break;case`Alt`:a=!0;break;case`Meta`:o=!0;break;case`Space`:n=` `;break;case`Plus`:n=`+`;break;case`Minus`:n=`-`;break;default:n=e;break}}),r===e.shiftKey&&i===e.ctrlKey&&a===e.altKey&&o===e.metaKey&&n===e.key}function Bc(e){return e.replace(/[A-Z](?:(?=[^A-Z])|[A-Z]*(?=[A-Z][^A-Z]|$))/g,(e,t)=>(t>0?`-`:``)+e.toLowerCase())}function Vc(e,t){let n=!1;return function(...r){n||(n=!0,setTimeout(()=>{e.apply(this,r),n=!1},t))}}function Hc(e){if(typeof e!=`object`||!e||Object.prototype.toString.call(e)!==`[object Object]`)return!1;if(Object.getPrototypeOf(e)===null)return!0;let t=e;for(;Object.getPrototypeOf(t)!==null;)t=Object.getPrototypeOf(t);return Object.getPrototypeOf(e)===t}function Uc(e,t){let n=t;return(function e(t,r){return Array.isArray(r)?(!t||!Array.isArray(t)?t=[]:t.length=0,r.forEach((n,r)=>{t[r]=e(null,n)})):typeof r==`object`?((!t||Array.isArray(t))&&(t={}),Object.keys(r).forEach(i=>{i!==`__proto__`&&(typeof r[i]!=`object`||!r[i]||!Hc(r[i])?t[i]=r[i]:r[i]!==n&&(t[i]?e(t[i],r[i]):t[i]=e(null,r[i])))})):t=r,t})(e,t)}function Wc(e){return Uc(null,e)}function Gc(e){return!e||Object.keys(e).length===0&&e.constructor===Object}function Kc(e){return e==null}function qc(...e){for(let t of e)if(!Kc(t))return t;return null}function Jc(e,t){if(e===t)return!0;if(Yc(e)&&Yc(t)){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(let n of Object.keys(e))if(!Jc(e[n],t[n]))return!1;return!0}else return!1}function Yc(e){return typeof e==`object`&&!!e}var $=class e extends Error{constructor(t,n){super(n&&n instanceof Error?`${t}: ${n.message}`:t),this.name=`PSVError`,Error.captureStackTrace?.(this,e)}};function Xc(e,t){Hc(e)?(t(e.initial,!0),e.promise.then(e=>t(e,!1))):t(e,!0)}function Zc(e){return{initial:!e.initial,promise:e.promise.then(e=>!e)}}function Qc(){let e=Error(`Loading was aborted.`);return e.name=`AbortError`,e}function $c(e){return e?.name===`AbortError`}function el(e){console.warn(`PhotoSphereViewer: ${e}`)}function tl(e){return!e||Array.isArray(e)?!1:[[`textureX`,`textureY`],[`yaw`,`pitch`]].some(([t,n])=>e[t]!==void 0&&e[n]!==void 0)}function nl(e,t,n=!0){let r=e.match(`<GPano:`+t+`>(.*)</GPano:`+t+`>`);if(r!==null){let e=n?parseInt(r[1],10):parseFloat(r[1]);return isNaN(e)?null:e}if(r=e.match(`GPano:`+t+`="(.*?)"`),r!==null){let e=n?parseInt(r[1],10):parseFloat(r[1]);return isNaN(e)?null:e}return null}var rl={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},il=[`left`,`center`,`right`],al=[`top`,`center`,`bottom`],ol=[...il,...al],sl=`center`;function cl(e){if(!e)return{x:.5,y:.5};if(typeof e==`object`)return e;let t=e.toLocaleLowerCase().split(` `).slice(0,2);t.length===1&&(t=rl[t[0]]?[t[0],sl]:[t[0],t[0]]);let n=t[1]!==`left`&&t[1]!==`right`&&t[0]!==`top`&&t[0]!==`bottom`;t=t.map(e=>rl[e]||e),n||t.reverse();let r=t.join(` `).match(/^([0-9.]+)% ([0-9.]+)%$/);return r?{x:parseFloat(r[1])/100,y:parseFloat(r[2])/100}:{x:.5,y:.5}}function ll(e,{allowCenter:t,cssOrder:n}={allowCenter:!0,cssOrder:!0}){return e?(typeof e==`string`&&(e=e.split(` `)),e.length===1&&(e[0]===sl?e=[sl,sl]:il.indexOf(e[0])===-1?al.indexOf(e[0])!==-1&&(e=[e[0],sl]):e=[sl,e[0]]),e.length!==2||ol.indexOf(e[0])===-1||ol.indexOf(e[1])===-1?(el(`Unparsable position ${e}`),null):!t&&e[0]===sl&&e[1]===sl?(el(`Invalid position center center`),null):(n&&!ul(e)&&(e=[e[1],e[0]]),e[1]===sl&&il.indexOf(e[0])!==-1&&(e=[sl,e[0]]),e[0]===sl&&al.indexOf(e[1])!==-1&&(e=[e[1],sl]),e)):null}function ul(e){return al.indexOf(e[0])!==-1&&il.indexOf(e[1])!==-1}function dl(e){let t;if(typeof e==`string`){let n=e.toString().trim(),r=parseFloat(n.replace(/^(-?[0-9]+(?:\.[0-9]*)?).*$/,`$1`)),i=n.replace(/^-?[0-9]+(?:\.[0-9]*)?(.*)$/,`$1`).trim();switch(i.match(/(pm|per minute)$/)&&(r/=60),i){case`dpm`:case`degrees per minute`:case`dps`:case`degrees per second`:t=B.degToRad(r);break;case`rdpm`:case`radians per minute`:case`rdps`:case`radians per second`:t=r;break;case`rpm`:case`revolutions per minute`:case`rps`:case`revolutions per second`:t=r*Math.PI*2;break;default:throw new $(`Unknown speed unit "${i}"`)}}else t=e;return t}function fl(e,t){if(typeof e!=`number`){let n=dl(e);return t/Math.abs(n)*1e3}else return Math.abs(e)}function pl(e,t=!1,n=t){let r;if(typeof e==`string`){let t=e.toLowerCase().trim().match(/^(-?[0-9]+(?:\.[0-9]*)?)(.*)$/);if(!t)throw new $(`Unknown angle "${e}"`);let n=parseFloat(t[1]),i=t[2];if(i)switch(i){case`deg`:case`degs`:r=B.degToRad(n);break;case`rad`:case`rads`:r=n;break;default:throw new $(`Unknown angle unit "${i}"`)}else r=n}else if(typeof e==`number`&&!isNaN(e))r=e;else throw new $(`Unknown angle "${e}"`);return r=_c(t?r+Math.PI:r,Math.PI*2),t?B.clamp(r-Math.PI,-Math.PI/(n?2:1),Math.PI/(n?2:1)):r}function ml(e,t){let n=function(n){let r=Wc({...e,...n}),i={};for(let[n,a]of Object.entries(r)){if(t&&n in t)a=t[n](a,{rawConfig:r,defValue:e[n]});else if(!(n in e)){el(`Unknown option ${n}`);continue}i[n]=a}return i};return n.defaults=e,n.parsers=t||{},n}function hl(e,t){Nc(e,`--psv-${t}-loaded`)!==`true`&&console.error(`PhotoSphereViewer: stylesheet "@photo-sphere-viewer/${t}/index.css" is not loaded`)}function gl(e,t,n){t&&t!==n&&console.error(`PhotoSphereViewer: @photo-sphere-viewer/${e} is in version ${t} but @photo-sphere-viewer/core is in version ${n}`)}function _l(e){do{if(e instanceof ShadowRoot&&e.mode===`closed`){console.error(`PhotoSphereViewer: closed shadow DOM detected, the viewer might not work as expected`);return}e=e.parentNode}while(e)}function vl(e,t,n,r){let i={isEquirectangular:!0,fullWidth:qc(n?.fullWidth,r?.fullWidth),fullHeight:qc(n?.fullHeight,r?.fullHeight),croppedWidth:qc(n?.croppedWidth,r?.croppedWidth,e),croppedHeight:qc(n?.croppedHeight,r?.croppedHeight,t),croppedX:qc(n?.croppedX,r?.croppedX),croppedY:qc(n?.croppedY,r?.croppedY),poseHeading:qc(n?.poseHeading,r?.poseHeading,0),posePitch:qc(n?.posePitch,r?.posePitch,0),poseRoll:qc(n?.poseRoll,r?.poseRoll,0),initialHeading:r?.initialHeading,initialPitch:r?.initialPitch,initialFov:r?.initialFov};if(i.croppedWidth!==e){let t=e/i.croppedWidth;[`fullWidth`,`fullHeight`,`croppedWidth`,`croppedHeight`,`croppedX`,`croppedY`].forEach(e=>{i[e]&&(i[e]=Math.round(i[e]*t))})}return!i.fullWidth&&!i.fullHeight&&(i.fullWidth=Math.max(i.croppedWidth,i.croppedHeight*2),i.fullHeight=Math.round(i.fullWidth/2)),i.fullWidth||=i.fullHeight*2,i.fullHeight||=Math.round(i.fullWidth/2),i.croppedX===null&&(i.croppedX=Math.round((i.fullWidth-e)/2)),i.croppedY===null&&(i.croppedY=Math.round((i.fullHeight-t)/2)),Math.abs(i.fullWidth-i.fullHeight*2)>1&&(el(`Invalid panoData, fullWidth should be twice fullHeight`),i.fullHeight=Math.round(i.fullWidth/2)),i.croppedX+i.croppedWidth>i.fullWidth&&(el(`Invalid panoData, croppedX + croppedWidth > fullWidth`),i.croppedX=i.fullWidth-i.croppedWidth),i.croppedY+i.croppedHeight>i.fullHeight&&(el(`Invalid panoData, croppedY + croppedHeight > fullHeight`),i.croppedY=i.fullHeight-i.croppedHeight),i.croppedX<0&&(el(`Invalid panoData, croppedX < 0`),i.croppedX=0),i.croppedY<0&&(el(`Invalid panoData, croppedY < 0`),i.croppedY=0),i}var yl=`${lc}_touchSupport`,bl={loaded:!1,pixelRatio:1,isWebGLSupported:!1,maxTextureWidth:0,isTouchEnabled:null,__maxCanvasWidth:null,isIphone:!1,get maxCanvasWidth(){return this.__maxCanvasWidth===null&&(this.__maxCanvasWidth=Cl(this.maxTextureWidth)),this.__maxCanvasWidth},load(){if(!this.loaded){let e=xl();this.pixelRatio=window.devicePixelRatio||1,this.isWebGLSupported=!!e,this.maxTextureWidth=e?e.getParameter(e.MAX_TEXTURE_SIZE):0,this.isTouchEnabled=Sl(),this.isIphone=/iPhone/i.test(navigator.userAgent),this.loaded=!0}if(!bl.isWebGLSupported)throw new $(`WebGL 2 is not supported.`);if(bl.maxTextureWidth===0)throw new $(`Unable to detect system capabilities`)}};function xl(){try{return document.createElement(`canvas`).getContext(`webgl2`)}catch{return null}}function Sl(){let e=`ontouchstart`in window||navigator.maxTouchPoints>0;yl in localStorage&&(e=localStorage[yl]===`true`);let t=new Promise(t=>{let n=()=>{window.removeEventListener(`mousedown`,r),window.removeEventListener(`touchstart`,i),clearTimeout(o)},r=()=>{n(),localStorage[yl]=!1,t(!1)},i=()=>{n(),localStorage[yl]=!0,t(!0)},a=()=>{n(),localStorage[yl]=e,t(e)};window.addEventListener(`mousedown`,r,!1),window.addEventListener(`touchstart`,i,!1);let o=setTimeout(a,1e4)});return{initial:e,promise:t}}function Cl(e){let t=e,n=!1,r=document.createElement(`canvas`),i=r.getContext(`2d`);for(r.width=1,r.height=1;t>1024&&!n;){let e=document.createElement(`canvas`),r=e.getContext(`2d`);e.width=t,e.height=t/2;try{r.fillStyle=`white`,r.fillRect(t-1,t/2-1,1,1),i.drawImage(e,t-1,t/2-1,1,1,0,0,1,1),i.getImageData(0,0,1,1).data[0]>0&&(n=!0)}catch{}e.width=0,e.height=0,n||(t/=2)}if(n)return t;throw new $(`Unable to detect system capabilities`)}function wl(e,t=!1){let n=new Ge(e);return n.needsUpdate=!0,n.minFilter=t?a:i,n.generateMipmaps=t,n.anisotropy=t?2:1,n}function Tl(e,t){if(t||e.width>bl.maxTextureWidth){let n=Math.min(1,bl.maxCanvasWidth/e.width),r=new OffscreenCanvas(Math.floor(e.width*n),Math.floor(e.height*n)),i=r.getContext(`2d`);return t&&(i.filter=`blur(${r.width/t.factor}px)`),i.drawImage(e,0,0,r.width,r.height),wl(r)}return wl(e)}var El=new Ne;function Dl(e,t){El.setFromEuler(t).invert(),e.applyQuaternion(El)}var Ol=class{constructor(e){this.easing=hc.linear,this.callbacks=[],this.resolved=!1,this.cancelled=!1,this.options=e,e?(e.easing&&(this.easing=typeof e.easing==`function`?e.easing:hc[e.easing]||hc.linear),this.delayTimeout=setTimeout(()=>{this.delayTimeout=void 0,this.animationFrame=window.requestAnimationFrame(e=>this.__run(e))},e.delay||0)):this.resolved=!0}__run(e){if(this.cancelled)return;this.start||=e;let t=(e-this.start)/this.options.duration,n={};if(t<1){for(let[e,r]of Object.entries(this.options.properties))r&&(n[e]=r.start+(r.end-r.start)*this.easing(t));this.options.onTick(n,t),this.animationFrame=window.requestAnimationFrame(e=>this.__run(e))}else{for(let[e,t]of Object.entries(this.options.properties))t&&(n[e]=t.end);this.options.onTick(n,1),this.__resolve(!0),this.animationFrame=void 0}}__resolve(e){e?this.resolved=!0:this.cancelled=!0,this.callbacks.forEach(t=>t(e)),this.callbacks.length=0}then(e){return this.resolved||this.cancelled?Promise.resolve(this.resolved).then(e):new Promise(e=>{this.callbacks.push(e)}).then(e)}cancel(){!this.cancelled&&!this.resolved&&(this.__resolve(!1),this.delayTimeout&&=(window.clearTimeout(this.delayTimeout),void 0),this.animationFrame&&=(window.cancelAnimationFrame(this.animationFrame),void 0))}},kl=class{constructor(e,t){if(this.fn=e,this.mode=0,this.speed=0,this.speedMult=0,this.currentSpeed=0,this.target=0,this.__current=0,this.min=t.min,this.max=t.max,this.wrap=t.wrap,this.current=t.defaultValue,this.wrap&&this.min!==0)throw new $(`invalid config`);this.fn&&this.fn(this.current)}get current(){return this.__current}set current(e){this.__current=e}setSpeed(e){this.speed=e}goto(e,t=1){this.mode=2,this.target=this.wrap?_c(e,this.max):B.clamp(e,this.min,this.max),this.speedMult=t}step(e,t=1){t===0?this.setValue(this.current+e):(this.mode!==2&&(this.target=this.current),this.goto(this.target+e,t))}roll(e=!1,t=1){this.mode=1,this.target=e?-1/0:1/0,this.speedMult=t}stop(){this.mode=0}setValue(e){return this.target=this.wrap?_c(e,this.max):B.clamp(e,this.min,this.max),this.mode=0,this.currentSpeed=0,this.target===this.current?!1:(this.current=this.target,this.fn&&this.fn(this.current),!0)}update(e){if(this.mode===2){this.wrap&&Math.abs(this.target-this.current)>this.max/2&&(this.current=this.current<this.target?this.current+this.max:this.current-this.max);let e=this.currentSpeed*this.currentSpeed/(this.speed*this.speedMult*4);Math.abs(this.target-this.current)<=e&&(this.mode=0)}let t=this.mode===0?0:this.speed*this.speedMult;this.target<this.current&&(t=-t),this.currentSpeed<t?this.currentSpeed=Math.min(t,this.currentSpeed+e/1e3*this.speed*this.speedMult*2):this.currentSpeed>t&&(this.currentSpeed=Math.max(t,this.currentSpeed-e/1e3*this.speed*this.speedMult*2));let n=null;return this.current>this.target&&this.currentSpeed?n=Math.max(this.target,this.current+this.currentSpeed*e/1e3):this.current<this.target&&this.currentSpeed&&(n=Math.min(this.target,this.current+this.currentSpeed*e/1e3)),n!==null&&(n=this.wrap?_c(n,this.max):B.clamp(n,this.min,this.max),n!==this.current)?(this.current=n,this.fn&&this.fn(this.current),!0):!1}},Al=class{constructor(e,t){this.fn=e,this.dynamics=t,this.fn&&this.fn(this.current)}get current(){return Object.entries(this.dynamics).reduce((e,[t,n])=>(e[t]=n.current,e),{})}setSpeed(e){for(let t of Object.values(this.dynamics))t.setSpeed(e)}goto(e,t=1){for(let[n,r]of Object.entries(e))this.dynamics[n].goto(r,t)}step(e,t=1){if(t===0)this.setValue(Object.keys(e).reduce((t,n)=>(t[n]=e[n]+this.dynamics[n].current,t),{}));else for(let[n,r]of Object.entries(e))this.dynamics[n].step(r,t)}roll(e,t=1){for(let[n,r]of Object.entries(e))this.dynamics[n].roll(r,t)}stop(){for(let e of Object.values(this.dynamics))e.stop()}setValue(e){let t=!1;for(let[n,r]of Object.entries(e))t=this.dynamics[n].setValue(r)||t;return t&&this.fn&&this.fn(this.current),t}update(e){let t=!1;for(let n of Object.values(this.dynamics))t=n.update(e)||t;return t&&this.fn&&this.fn(this.current),t}},jl=class{constructor(e=200){this.delay=e,this.time=0,this.delay=e}get pending(){return this.time!==0}down(e){this.timeout&&=(clearTimeout(this.timeout),void 0),this.time=new Date().getTime(),this.data=e}up(e){this.time&&(Date.now()-this.time<this.delay?this.timeout=setTimeout(()=>{e(this.data),this.timeout=void 0,this.time=0,this.data=void 0},this.delay):(e(this.data),this.time=0,this.data=void 0))}},Ml=(e=>(e.VERTICAL=`VERTICAL`,e.HORIZONTAL=`HORIZONTAL`,e))(Ml||{}),Nl=class{constructor(e,t,n){this.container=e,this.direction=t,this.listener=n,this.mousedown=!1,this.mouseover=!1,this.container.addEventListener(`click`,this),this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`mouseenter`,this),this.container.addEventListener(`mouseleave`,this),this.container.addEventListener(`touchstart`,this),this.container.addEventListener(`mousemove`,this,!0),this.container.addEventListener(`touchmove`,this,!0),window.addEventListener(`mouseup`,this),window.addEventListener(`touchend`,this)}get isVertical(){return this.direction===`VERTICAL`}get isHorizontal(){return this.direction===`HORIZONTAL`}destroy(){window.removeEventListener(`mouseup`,this),window.removeEventListener(`touchend`,this)}handleEvent(e){switch(e.type){case`click`:e.stopPropagation();break;case`mousedown`:this.__onMouseDown(e);break;case`mouseenter`:this.__onMouseEnter(e);break;case`mouseleave`:this.__onMouseLeave(e);break;case`touchstart`:this.__onTouchStart(e);break;case`mousemove`:this.__onMouseMove(e);break;case`touchmove`:this.__onTouchMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchend`:this.__onTouchEnd(e);break}}__onMouseDown(e){this.mousedown=!0,this.__update(e.clientX,e.clientY,!0)}__onMouseEnter(e){this.mouseover=!0,this.__update(e.clientX,e.clientY,!0)}__onTouchStart(e){this.mouseover=!0,this.mousedown=!0;let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!0)}__onMouseMove(e){(this.mousedown||this.mouseover)&&(e.stopPropagation(),this.__update(e.clientX,e.clientY,!0))}__onTouchMove(e){if(this.mousedown||this.mouseover){e.stopPropagation();let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!0)}}__onMouseUp(e){this.mousedown&&(this.mousedown=!1,this.__update(e.clientX,e.clientY,!1))}__onMouseLeave(e){this.mouseover&&(this.mouseover=!1,this.__update(e.clientX,e.clientY,!0))}__onTouchEnd(e){if(this.mousedown){this.mouseover=!1,this.mousedown=!1;let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!1)}}__update(e,t,n){let r=this.container.getBoundingClientRect(),i;i=this.isVertical?B.clamp((r.bottom-t)/r.height,0,1):B.clamp((e-r.left)/r.width,0,1),this.listener({value:i,click:!n,mousedown:this.mousedown,mouseover:this.mouseover,cursor:{clientX:e,clientY:t}})}},Pl={};Gs(Pl,{BeforeAnimateEvent:()=>zl,BeforeRenderEvent:()=>Vl,BeforeRotateEvent:()=>Ul,ClickEvent:()=>Gl,ConfigChangedEvent:()=>ql,DoubleClickEvent:()=>Yl,FullscreenEvent:()=>Zl,HideNotificationEvent:()=>$l,HideOverlayEvent:()=>tu,HidePanelEvent:()=>ru,HideTooltipEvent:()=>au,KeypressEvent:()=>su,LoadProgressEvent:()=>lu,ObjectEnterEvent:()=>Hu,ObjectEvent:()=>Bu,ObjectHoverEvent:()=>Ku,ObjectLeaveEvent:()=>Wu,PanoramaErrorEvent:()=>hu,PanoramaLoadEvent:()=>du,PanoramaLoadedEvent:()=>pu,PositionUpdatedEvent:()=>yu,ReadyEvent:()=>Cu,RenderEvent:()=>Tu,RollUpdatedEvent:()=>xu,ShowNotificationEvent:()=>Du,ShowOverlayEvent:()=>ku,ShowPanelEvent:()=>ju,ShowTooltipEvent:()=>Nu,SizeUpdatedEvent:()=>Fu,StopAllEvent:()=>Lu,TransitionDoneEvent:()=>_u,ViewerEvent:()=>Ll,ZoomUpdatedEvent:()=>zu});var Fl=class extends Event{constructor(e,t=!1){super(e,{cancelable:t})}},Il=class extends EventTarget{dispatchEvent(e){return super.dispatchEvent(e)}addEventListener(e,t,n){super.addEventListener(e,t,n)}removeEventListener(e,t,n){super.removeEventListener(e,t,n)}},Ll=class extends Fl{},Rl=class e extends Ll{constructor(t,n){super(e.type,!0),this.position=t,this.zoomLevel=n}};Rl.type=`before-animate`;var zl=Rl,Bl=class e extends Ll{constructor(t,n){super(e.type),this.timestamp=t,this.elapsed=n}};Bl.type=`before-render`;var Vl=Bl,Hl=class e extends Ll{constructor(t){super(e.type,!0),this.position=t}};Hl.type=`before-rotate`;var Ul=Hl,Wl=class e extends Ll{constructor(t){super(e.type),this.data=t}};Wl.type=`click`;var Gl=Wl,Kl=class e extends Ll{constructor(t){super(e.type),this.options=t}containsOptions(...e){return e.some(e=>this.options.includes(e))}};Kl.type=`config-changed`;var ql=Kl,Jl=class e extends Ll{constructor(t){super(e.type),this.data=t}};Jl.type=`dblclick`;var Yl=Jl,Xl=class e extends Ll{constructor(t){super(e.type),this.fullscreenEnabled=t}};Xl.type=`fullscreen`;var Zl=Xl,Ql=class e extends Ll{constructor(t){super(e.type),this.notificationId=t}};Ql.type=`hide-notification`;var $l=Ql,eu=class e extends Ll{constructor(t){super(e.type),this.overlayId=t}};eu.type=`hide-overlay`;var tu=eu,nu=class e extends Ll{constructor(t){super(e.type),this.panelId=t}};nu.type=`hide-panel`;var ru=nu,iu=class e extends Ll{constructor(t){super(e.type),this.tooltipData=t}};iu.type=`hide-tooltip`;var au=iu,ou=class e extends Ll{constructor(t,n){super(e.type,!0),this.key=t,this.originalEvent=n}matches(e){return zc(this.originalEvent,e)}};ou.type=`key-press`;var su=ou,cu=class e extends Ll{constructor(t){super(e.type),this.progress=t}};cu.type=`load-progress`;var lu=cu,uu=class e extends Ll{constructor(t){super(e.type),this.panorama=t}};uu.type=`panorama-load`;var du=uu,fu=class e extends Ll{constructor(t){super(e.type),this.data=t}};fu.type=`panorama-loaded`;var pu=fu,mu=class e extends Ll{constructor(t,n){super(e.type),this.panorama=t,this.error=n}};mu.type=`panorama-error`;var hu=mu,gu=class e extends Ll{constructor(t){super(e.type),this.completed=t}};gu.type=`transition-done`;var _u=gu,vu=class e extends Ll{constructor(t){super(e.type),this.position=t}};vu.type=`position-updated`;var yu=vu,bu=class e extends Ll{constructor(t){super(e.type),this.roll=t}};bu.type=`roll-updated`;var xu=bu,Su=class e extends Ll{constructor(){super(e.type)}};Su.type=`ready`;var Cu=Su,wu=class e extends Ll{constructor(){super(e.type)}};wu.type=`render`;var Tu=wu,Eu=class e extends Ll{constructor(t){super(e.type),this.notificationId=t}};Eu.type=`show-notification`;var Du=Eu,Ou=class e extends Ll{constructor(t){super(e.type),this.overlayId=t}};Ou.type=`show-overlay`;var ku=Ou,Au=class e extends Ll{constructor(t){super(e.type),this.panelId=t}};Au.type=`show-panel`;var ju=Au,Mu=class e extends Ll{constructor(t,n){super(e.type),this.tooltip=t,this.tooltipData=n}};Mu.type=`show-tooltip`;var Nu=Mu,Pu=class e extends Ll{constructor(t){super(e.type),this.size=t}};Pu.type=`size-updated`;var Fu=Pu,Iu=class e extends Ll{constructor(){super(e.type)}};Iu.type=`stop-all`;var Lu=Iu,Ru=class e extends Ll{constructor(t){super(e.type),this.zoomLevel=t}};Ru.type=`zoom-updated`;var zu=Ru,Bu=class extends Ll{constructor(e,t,n,r,i){super(e),this.originalEvent=t,this.object=n,this.viewerPoint=r,this.userDataKey=i}},Vu=class e extends Bu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};Vu.type=`enter-object`;var Hu=Vu,Uu=class e extends Bu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};Uu.type=`leave-object`;var Wu=Uu,Gu=class e extends Bu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};Gu.type=`hover-object`;var Ku=Gu,qu=class{constructor(e){this.viewer=e}init(){}destroy(){}supportsTransition(e){return!1}supportsPreload(e){return!1}textureCoordsToSphericalCoords(e,t){throw new $(`Current adapter does not support texture coordinates.`)}sphericalCoordsToTextureCoords(e,t){throw new $(`Current adapter does not support texture coordinates.`)}};qu.supportsDownload=!1;function Ju(e){if(e){for(let[,t]of[[`_`,e],...Object.entries(e)])if(t.prototype instanceof qu)return gl(t.id,t.VERSION,`5.15.1`),t}return null}var Yu=`varying vec3 vLocalPos;
...
`,Xu=`// Ray-cast inputs in the panorama's local frame, so sphereCorrection and pose
...
`,Zu=ml({shader:!1,resolution:64,useXmpData:!0},{resolution:e=>{if(!e||!B.isPowerOfTwo(e))throw new $(`EquirectangularAdapter resolution must be power of two.`);return e}}),Qu=class e extends qu{static withConfig(t){return[e,t]}constructor(e,t){super(e),this.config=Zu(t),this.SPHERE_SEGMENTS=this.config.resolution,this.SPHERE_HORIZONTAL_SEGMENTS=this.SPHERE_SEGMENTS/2}supportsTransition(){return!0}supportsPreload(){return!0}textureCoordsToSphericalCoords(e,t){if(Kc(e.textureX)||Kc(e.textureY))throw new $(`Texture position is missing 'textureX' or 'textureY'`);let n=(e.textureX+t.croppedX)/t.fullWidth*Math.PI*2,r=(e.textureY+t.croppedY)/t.fullHeight*Math.PI;return{yaw:n>=Math.PI?n-Math.PI:n+Math.PI,pitch:Math.PI/2-r}}sphericalCoordsToTextureCoords(e,t){let n=e.yaw/Math.PI/2*t.fullWidth,r=e.pitch/Math.PI*t.fullHeight,i=Math.round(e.yaw<Math.PI?n+t.fullWidth/2:n-t.fullWidth/2)-t.croppedX,a=Math.round(t.fullHeight/2-r)-t.croppedY;return(i<0||i>t.croppedWidth||a<0||a>t.croppedHeight)&&(i=a=void 0),{textureX:i,textureY:a}}async loadTexture(e,t=!0,n,r=this.config.useXmpData){if(typeof e!=`string`&&(typeof e!=`object`||!e.path))return Promise.reject(new $(`Invalid panorama url, are you using the right adapter?`));let i;i=typeof e==`string`?{path:e,data:n}:{data:n,...e};let a=await this.viewer.textureLoader.loadFile(i.path,t?e=>this.viewer.textureLoader.dispatchProgress(e):null,i.path),o=r?await this.loadXMP(a):null,s=await this.viewer.textureLoader.blobToImage(a);typeof i.data==`function`&&(i.data=i.data(s,o));let c=vl(s.width,s.height,i.data,o);return{panorama:e,texture:Tl(s,i.blur?{factor:2048}:null),panoData:c,cacheKey:i.path}}async loadXMP(e){let t=await this.loadBlobAsString(e),n=t.indexOf(`<x:xmpmeta`);if(n===-1)return null;let r=t.indexOf(`</x:xmpmeta>`,n);if(r===-1)return null;let i=t.substring(n,r);return i.includes(`GPano:`)?{fullWidth:nl(i,`FullPanoWidthPixels`),fullHeight:nl(i,`FullPanoHeightPixels`),croppedWidth:nl(i,`CroppedAreaImageWidthPixels`),croppedHeight:nl(i,`CroppedAreaImageHeightPixels`),croppedX:nl(i,`CroppedAreaLeftPixels`),croppedY:nl(i,`CroppedAreaTopPixels`),poseHeading:nl(i,`PoseHeadingDegrees`,!1),posePitch:nl(i,`PosePitchDegrees`,!1),poseRoll:nl(i,`PoseRollDegrees`,!1),initialHeading:nl(i,`InitialViewHeadingDegrees`,!1),initialPitch:nl(i,`InitialViewPitchDegrees`,!1),initialFov:nl(i,`InitialHorizontalFOVDegrees`,!1)}:null}loadBlobAsString(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=n,r.readAsText(e)})}createMesh(e){if(this.config.shader)return new Xn(new mr(cc,32,16).scale(-1,1,1),new Cr({uniforms:{map:{value:null},opacity:{value:1},radius:{value:cc},uvOffset:{value:new V(e.croppedX/e.fullWidth,(e.fullHeight-e.croppedY-e.croppedHeight)/e.fullHeight)},uvScale:{value:new V(e.croppedWidth/e.fullWidth,e.croppedHeight/e.fullHeight)}},vertexShader:Xu,fragmentShader:Yu,depthTest:!1,depthWrite:!1,transparent:!0}));{let t=e.croppedX/e.fullWidth*2*Math.PI,n=e.croppedWidth/e.fullWidth*2*Math.PI,r=e.croppedY/e.fullHeight*Math.PI,i=e.croppedHeight/e.fullHeight*Math.PI;return new Xn(new mr(cc,Math.round(this.SPHERE_SEGMENTS/(2*Math.PI)*n),Math.round(this.SPHERE_HORIZONTAL_SEGMENTS/Math.PI*i),-Math.PI/2+t,n,r,i).scale(-1,1,1),new Rn({depthTest:!1,depthWrite:!1}))}}setTexture(e,t){this.config.shader?e.material.uniforms.map.value=t.texture:e.material.map=t.texture}setTextureOpacity(e,t){this.config.shader?e.material.uniforms.opacity.value=t:(e.material.opacity=t,e.material.transparent=t<1)}disposeTexture({texture:e}){e.dispose()}disposeMesh(e){e.geometry.dispose(),e.material.dispose()}};Qu.id=`equirectangular`,Qu.VERSION=`5.15.1`,Qu.supportsDownload=!0;var $u=Qu,ed=class e extends $u{static withConfig(t){return[e,t]}constructor(e,t){super(e,{resolution:t?.resolution??64,useXmpData:!1}),el(`"DualFisheyeAdapter" must be imported from "@photo-sphere-viewer/dual-fisheye-adapter" package`)}async loadTexture(e,t){let n=await super.loadTexture(e,t,null,!1);return n.panoData=null,n}createMesh(){let e=new mr(cc,this.SPHERE_SEGMENTS,this.SPHERE_HORIZONTAL_SEGMENTS).scale(-1,1,1).toNonIndexed(),t=e.getAttribute(`uv`),n=e.getAttribute(`normal`);for(let e=0;e<t.count;e++)for(let r=0;r<3;r++){let i=e*3+r,a=n.getX(i),o=n.getY(i),s=n.getZ(i),c=.947;if(e<t.count/6){let e=a===0&&s===0?1:Math.acos(o)/Math.sqrt(a*a+s*s)*(2/Math.PI);t.setXY(i,c/4*a*e+1/4,c/2*s*e+1/2)}else{let e=a===0&&s===0?1:Math.acos(-o)/Math.sqrt(a*a+s*s)*(2/Math.PI);t.setXY(i,-a*(c/4)*e+3/4,c/2*s*e+1/2)}}return e.rotateX(-Math.PI/2),e.rotateY(Math.PI),new Xn(e,new Rn({depthTest:!1,depthWrite:!1}))}};ed.id=`dual-fisheye`,ed.VERSION=`5.15.1`;var td=ed,nd=class e{constructor(t,n){this.parent=t,this.children=[],this.state={visible:!0},this.viewer=t instanceof e?t.viewer:t,this.container=document.createElement(n.tagName??`div`),this.container.className=n.className||``,this.parent.children.push(this),this.parent.container.appendChild(this.container)}destroy(){this.parent.container.removeChild(this.container);let e=this.parent.children.indexOf(this);e!==-1&&this.parent.children.splice(e,1),this.children.slice().forEach(e=>e.destroy()),this.children.length=0}toggle(e=!this.isVisible()){e?this.show():this.hide()}hide(e){this.container.style.display=`none`,this.state.visible=!1}show(e){this.container.style.display=``,this.state.visible=!0}isVisible(){return this.state.visible}},rd=ml({id:null,tagName:null,className:null,title:null,hoverScale:!1,collapsable:!1,tabbable:!0,icon:null,iconActive:null}),id=class extends nd{constructor(e,t){super(e,{tagName:t.tagName,className:`psv-button ${t.hoverScale?`psv-button--hover-scale`:``} ${t.className||``}`}),this.state={visible:!0,enabled:!0,supported:!0,collapsed:!1,active:!1,width:0},this.config=rd(t),t.id||(this.config.id=this.constructor.id),t.icon&&this.__setIcon(t.icon),this.state.width=this.container.offsetWidth,this.config.title?this.container.title=this.viewer.config.lang[this.config.title]??this.config.title:this.id&&this.id in this.viewer.config.lang&&(this.container.title=this.viewer.config.lang[this.id]),t.tabbable&&(this.container.tabIndex=0),this.container.addEventListener(`click`,e=>{this.state.enabled&&this.onClick(),e.stopPropagation()}),this.container.addEventListener(`keydown`,e=>{e.key===pc.Enter&&this.state.enabled&&(this.onClick(),e.stopPropagation())})}get id(){return this.config.id}get title(){return this.container.title}get content(){return this.container.innerHTML}get width(){return this.state.width}get collapsable(){return this.config.collapsable}show(e=!0){this.isVisible()||(this.state.visible=!0,this.state.collapsed||(this.container.style.display=``),e&&this.viewer.navbar.autoSize())}hide(e=!0){this.isVisible()&&(this.state.visible=!1,this.container.style.display=`none`,e&&this.viewer.navbar.autoSize())}checkSupported(){Xc(this.isSupported(),(e,t)=>{this.state&&(this.state.supported=e,t?e||this.hide():this.toggle(e))})}autoSize(){}isSupported(){return!0}toggleActive(e=!this.state.active){e!==this.state.active&&(this.state.active=e,Tc(this.container,`psv-button--active`,this.state.active),this.config.iconActive&&this.__setIcon(this.state.active?this.config.iconActive:this.config.icon))}disable(){this.container.classList.add(`psv-button--disabled`),this.state.enabled=!1}enable(){this.container.classList.remove(`psv-button--disabled`),this.state.enabled=!0}collapse(){this.state.collapsed=!0,this.container.style.display=`none`}uncollapse(){this.state.collapsed=!1,this.state.visible&&(this.container.style.display=``)}__setIcon(e){this.container.innerHTML=e,Ec(this.container.querySelector(`svg`),`psv-button-svg`)}},ad=class extends id{constructor(e,t){super(e,{id:t.id??`psvButton-${Math.random().toString(36).substring(2)}`,className:`psv-custom-button ${t.className||``}`,hoverScale:!1,collapsable:t.collapsable!==!1,tabbable:t.tabbable!==!1,title:t.title}),this.customOnClick=t.onClick,t.content&&(typeof t.content==`string`?this.container.innerHTML=t.content:(this.container.classList.add(`psv-custom-button--no-padding`),t.content.style.height=`100%`,t.content.attachViewer?.(this.viewer),this.container.appendChild(t.content))),this.state.width=this.container.offsetWidth,t.disabled&&this.disable(),t.visible===!1&&this.hide()}onClick(){this.customOnClick?.(this.viewer)}},od=class extends id{constructor(e){super(e,{className:`psv-description-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:mc.info}),this.mode=0,this.viewer.addEventListener($l.type,this),this.viewer.addEventListener(Du.type,this),this.viewer.addEventListener(ru.type,this),this.viewer.addEventListener(ju.type,this),this.viewer.addEventListener(ql.type,this)}destroy(){this.viewer.removeEventListener($l.type,this),this.viewer.removeEventListener(Du.type,this),this.viewer.removeEventListener(ru.type,this),this.viewer.removeEventListener(ju.type,this),this.viewer.removeEventListener(ql.type,this),super.destroy()}handleEvent(e){if(e instanceof ql){e.containsOptions(`description`)&&this.autoSize(!0);return}if(!this.mode)return;let t=!1;e instanceof $l?t=this.mode===1:e instanceof Du?t=this.mode===1&&e.notificationId!==fc.DESCRIPTION:e instanceof ru?t=this.mode===2:e instanceof ju&&(t=this.mode===2&&e.panelId!==fc.DESCRIPTION),t&&(this.toggleActive(!1),this.mode=0)}onClick(){this.mode?this.__close():this.__open()}hide(e){super.hide(e),this.mode&&this.__close()}autoSize(e=!1){if(e){let e=this.viewer.navbar.getButton(`caption`,!1),t=e&&!e.isVisible(),n=!!this.viewer.config.description;t||n?this.show(!1):this.hide(!1)}}__close(){switch(this.mode){case 1:this.viewer.notification.hide(fc.DESCRIPTION);break;case 2:this.viewer.panel.hide(fc.DESCRIPTION);break;default:}}__open(){this.toggleActive(!0),this.viewer.config.description?(this.mode=2,this.viewer.panel.show({id:fc.DESCRIPTION,content:`${this.viewer.config.caption?`<p>${this.viewer.config.caption}</p>`:``}${this.viewer.config.description}`})):(this.mode=1,this.viewer.notification.show({id:fc.DESCRIPTION,content:this.viewer.config.caption}))}};od.id=`description`;var sd=class extends id{constructor(e){super(e,{tagName:`a`,className:`psv-download-button`,hoverScale:!0,collapsable:!0,tabbable:!0,icon:mc.download}),this.viewer.addEventListener(ql.type,this),this.viewer.addEventListener(pu.type,this)}destroy(){this.viewer.removeEventListener(ql.type,this),this.viewer.removeEventListener(pu.type,this),super.destroy()}handleEvent(e){e instanceof ql?(e.containsOptions(`downloadUrl`)&&this.checkSupported(),e.containsOptions(`downloadUrl`,`downloadName`)&&this.__update()):e instanceof pu&&this.__update()}onClick(){}checkSupported(){this.viewer.adapter.constructor.supportsDownload||this.viewer.config.downloadUrl?this.show():this.hide()}__update(){let e=this.container;e.href=this.viewer.config.downloadUrl||this.viewer.config.panorama,e.target=`_blank`,e.href.startsWith(`data:`)&&!this.viewer.config.downloadName?e.download=`panorama.`+e.href.substring(0,e.href.indexOf(`;`)).split(`/`).pop():e.download=this.viewer.config.downloadName||e.href.split(`/`).pop()}};sd.id=`download`;var cd=class extends id{constructor(e){super(e,{className:`psv-fullscreen-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:mc.fullscreenIn,iconActive:mc.fullscreenOut}),this.viewer.addEventListener(Zl.type,this)}destroy(){this.viewer.removeEventListener(Zl.type,this),super.destroy()}handleEvent(e){e instanceof Zl&&this.toggleActive(e.fullscreenEnabled)}onClick(){this.viewer.toggleFullscreen()}};cd.id=`fullscreen`;var ld=`psvButton`,ud=(e,t)=>`
<div class="psv-panel-menu psv-panel-menu--stripped">
  <h1 class="psv-panel-menu-title">${mc.menu} ${t}</h1>
...
`,dd=class extends id{constructor(e){super(e,{className:`psv-menu-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:mc.menu}),this.viewer.addEventListener(ju.type,this),this.viewer.addEventListener(ru.type,this),super.hide()}destroy(){this.viewer.removeEventListener(ju.type,this),this.viewer.removeEventListener(ru.type,this),super.destroy()}handleEvent(e){e instanceof ju?this.toggleActive(e.panelId===fc.MENU):e instanceof ru&&this.toggleActive(!1)}onClick(){this.state.active?this.__hideMenu():this.__showMenu()}hide(e){super.hide(e),this.__hideMenu()}show(e){super.show(e),this.state.active&&this.__showMenu()}__showMenu(){this.viewer.panel.show({id:fc.MENU,content:ud(this.viewer.navbar.collapsed,this.viewer.config.lang.menu),noMargin:!0,clickHandler:e=>{let t=e?kc(e,`.psv-panel-menu-item`):void 0,n=t?t.dataset[ld]:void 0;n&&(this.viewer.navbar.getButton(n).onClick(),this.__hideMenu())}})}__hideMenu(){this.viewer.panel.hide(fc.MENU)}};dd.id=`menu`;function fd(e){let t;switch(e){case 0:t=90;break;case 1:t=-90;break;case 3:t=180;break;default:t=0;break}return mc.arrow.replace(`rotate(0`,`rotate(${t}`)}var pd=class extends id{constructor(e,t){super(e,{className:`psv-move-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:fd(t)}),this.direction=t,this.handler=new jl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===pc.Enter&&this.__onMouseDown();break;case`keyup`:e.key===pc.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return Zc(bl.isTouchEnabled)}__onMouseDown(){if(!this.state.enabled)return;let e={};switch(this.direction){case 0:e.pitch=!1;break;case 1:e.pitch=!0;break;case 3:e.yaw=!1;break;default:e.yaw=!0;break}this.viewer.stopAll(),this.viewer.dynamics.position.roll(e),this.handler.down()}__onMouseUp(){this.state.enabled&&this.handler.up(()=>{this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer()})}};pd.groupId=`move`;var md=class extends pd{constructor(e){super(e,1)}};md.id=`moveDown`;var hd=class extends pd{constructor(e){super(e,2)}};hd.id=`moveLeft`;var gd=class extends pd{constructor(e){super(e,3)}};gd.id=`moveRight`;var _d=class extends pd{constructor(e){super(e,0)}};_d.id=`moveUp`;var vd=class extends id{constructor(e,t,n){super(e,{className:`psv-zoom-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:t}),this.direction=n,this.handler=new jl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===pc.Enter&&this.__onMouseDown();break;case`keyup`:e.key===pc.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return Zc(bl.isTouchEnabled)}__onMouseDown(){this.state.enabled&&(this.viewer.dynamics.zoom.roll(this.direction===1),this.handler.down())}__onMouseUp(){this.state.enabled&&this.handler.up(()=>this.viewer.dynamics.zoom.stop())}};vd.groupId=`zoom`;var yd=class extends vd{constructor(e){super(e,mc.zoomIn,0)}};yd.id=`zoomIn`;var bd=class extends vd{constructor(e){super(e,mc.zoomOut,1)}};bd.id=`zoomOut`;var xd=class extends id{constructor(e){super(e,{className:`psv-zoom-range`,hoverScale:!1,collapsable:!1,tabbable:!1}),this.zoomRange=document.createElement(`div`),this.zoomRange.className=`psv-zoom-range-line`,this.container.appendChild(this.zoomRange),this.zoomValue=document.createElement(`div`),this.zoomValue.className=`psv-zoom-range-handle`,this.zoomRange.appendChild(this.zoomValue),this.slider=new Nl(this.container,`HORIZONTAL`,e=>this.__onSliderUpdate(e)),this.mediaMinWidth=parseInt(Nc(this.container,`max-width`),10),this.viewer.addEventListener(zu.type,this),this.viewer.state.ready?this.__moveZoomValue(this.viewer.getZoomLevel()):this.viewer.addEventListener(Cu.type,this)}destroy(){this.slider.destroy(),this.viewer.removeEventListener(zu.type,this),this.viewer.removeEventListener(Cu.type,this),super.destroy()}handleEvent(e){e instanceof zu?this.__moveZoomValue(e.zoomLevel):e instanceof Cu&&this.__moveZoomValue(this.viewer.getZoomLevel())}onClick(){}isSupported(){return Zc(bl.isTouchEnabled)}autoSize(){this.state.supported&&(this.viewer.state.size.width<=this.mediaMinWidth&&this.state.visible?this.hide(!1):this.viewer.state.size.width>this.mediaMinWidth&&!this.state.visible&&this.show(!1))}__moveZoomValue(e){this.zoomValue.style.left=e/100*this.zoomRange.offsetWidth-this.zoomValue.offsetWidth/2+`px`}__onSliderUpdate(e){e.mousedown&&this.viewer.zoom(e.value*100)}};xd.id=`zoomRange`,xd.groupId=`zoom`;var Sd=class extends Il{constructor(e){super(),this.viewer=e}init(){}destroy(){}},Cd=class extends Sd{constructor(e,t){super(e),this.config=this.constructor.configParser(t)}setOption(e,t){this.setOptions({[e]:t})}setOptions(e){let t={...this.config,...e},n=this.constructor,r=n.configParser,i=n.readonlyOptions,a=n.id;for(let[n,o]of Object.entries(e)){if(!(n in r.defaults)){el(`${a}: Unknown option "${n}"`);continue}if(i.includes(n)){el(`${a}: Option "${n}" cannot be updated`);continue}n in r.parsers&&(o=r.parsers[n](o,{rawConfig:t,defValue:r.defaults[n]})),this.config[n]=o}}};Cd.readonlyOptions=[];function wd(e){if(e){for(let[,t]of[[`_`,e],...Object.entries(e)])if(t.prototype instanceof Sd)return gl(t.id,t.VERSION,`5.15.1`),t}return null}var Td={panorama:null,container:null,adapter:[$u,null],plugins:[],caption:null,description:null,downloadUrl:null,downloadName:null,loadingImg:null,loadingTxt:``,size:null,fisheye:0,minFov:30,maxFov:90,defaultZoomLvl:50,defaultYaw:0,defaultPitch:0,sphereCorrection:null,moveSpeed:1,zoomSpeed:1,moveInertia:.8,mousewheel:!0,mousemove:!0,mousewheelCtrlKey:!1,touchmoveTwoFingers:!1,panoData:null,requestHeaders:null,canvasBackground:`#000`,defaultTransition:{speed:1500,rotation:!0,effect:`fade`},rendererParameters:{alpha:!0,antialias:!0},withCredentials:()=>!1,navbar:[`zoom`,`move`,`download`,`description`,`caption`,`fullscreen`],lang:{zoom:`Zoom`,zoomOut:`Zoom out`,zoomIn:`Zoom in`,moveUp:`Move up`,moveDown:`Move down`,moveLeft:`Move left`,moveRight:`Move right`,description:`Description`,download:`Download`,fullscreen:`Fullscreen`,loading:`Loading...`,menu:`Menu`,close:`Close`,twoFingers:`Use two fingers to navigate`,ctrlZoom:`Use ctrl + scroll to zoom the image`,loadError:`The panorama cannot be loaded`,webglError:`Your browser does not seem to support WebGL`},keyboard:`fullscreen`,keyboardActions:{[pc.ArrowUp]:`ROTATE_UP`,[pc.ArrowDown]:`ROTATE_DOWN`,[pc.ArrowRight]:`ROTATE_RIGHT`,[pc.ArrowLeft]:`ROTATE_LEFT`,[pc.PageUp]:`ZOOM_IN`,[pc.PageDown]:`ZOOM_OUT`,[pc.Plus]:`ZOOM_IN`,[pc.Minus]:`ZOOM_OUT`}},Ed={panorama:`Use setPanorama method to change the panorama`,panoData:`Use setPanorama method to change the panorama`,container:`Cannot change viewer container`,adapter:`Cannot change adapter`,plugins:`Cannot change plugins`},Dd={container:e=>{if(!e)throw new $(`No value given for container.`);return e},adapter:(e,{defValue:t})=>{if(e=e?Array.isArray(e)?[Ju(e[0]),e[1]]:[Ju(e),null]:t,!e[0])throw new $(`An undefined value was given for adapter.`);if(!e[0].id)throw new $(`Adapter has no id.`);return e},defaultYaw:e=>pl(e),defaultPitch:e=>pl(e,!0),defaultZoomLvl:e=>B.clamp(e,0,100),minFov:(e,{rawConfig:t})=>(t.maxFov<e&&(el(`maxFov cannot be lower than minFov`),e=t.maxFov),B.clamp(e,1,179)),maxFov:(e,{rawConfig:t})=>(e<t.minFov&&(e=t.minFov),B.clamp(e,1,179)),moveInertia:(e,{defValue:t})=>e===!0?t:e===!1?0:e,lang:e=>({...Td.lang,...e}),fisheye:e=>e===!0?1:e===!1?0:B.clamp(e,0,2),requestHeaders:e=>e&&typeof e==`object`?()=>e:typeof e==`function`?e:null,withCredentials:e=>typeof e==`boolean`?()=>e:typeof e==`function`?e:()=>!1,defaultTransition:(e,{defValue:t})=>e===null||e.speed===0?null:{...t,...e},rendererParameters:(e,{defValue:t})=>({...e,...t}),plugins:e=>e.map((e,t)=>{if(e=Array.isArray(e)?[wd(e[0]),e[1]]:[wd(e),null],!e[0])throw new $(`An undefined value was given for plugin ${t}.`);if(!e[0].id)throw new $(`Plugin ${t} has no id.`);return e}),navbar:e=>e===!1?null:e===!0?Wc(Td.navbar):typeof e==`string`?e.split(/[ ,]/):e},Od=ml(Td,Dd),kd=class extends id{constructor(e){super(e,{className:`psv-caption`,hoverScale:!1,collapsable:!1,tabbable:!0}),this.contentWidth=0,this.state.width=0,this.contentElt=document.createElement(`div`),this.contentElt.className=`psv-caption-content`,this.container.appendChild(this.contentElt),this.setCaption(this.viewer.config.caption)}hide(){this.contentElt.style.display=`none`,this.state.visible=!1}show(){this.contentElt.style.display=``,this.state.visible=!0}onClick(){}setCaption(e){this.show(),this.contentElt.innerHTML=e??``,this.contentElt.innerHTML?this.contentWidth=this.contentElt.offsetWidth:this.contentWidth=0,this.autoSize()}autoSize(){this.toggle(this.container.offsetWidth>=this.contentWidth),this.__refreshButton()}__refreshButton(){this.viewer.navbar.getButton(od.id,!1)?.autoSize(!0)}};kd.id=`caption`;var Ad={},jd={};function Md(e,t){if(!e.id)throw new $(`Button id is required`);if(Ad[e.id]=e,e.groupId&&(jd[e.groupId]=jd[e.groupId]||[]).push(e),t){let n=Td.navbar;switch(t){case`start`:n.unshift(e.id);break;case`end`:n.push(e.id);break;default:{let[r,i]=t.split(`:`),a=n.indexOf(r);if(!r||!i||a===-1)throw new $(`Invalid defaultPosition ${t}`);n.splice(a+ +(i===`right`),0,e.id)}}}}[bd,xd,yd,od,kd,sd,cd,hd,gd,_d,md].forEach(e=>Md(e));var Nd=class extends nd{constructor(e){super(e,{className:`psv-navbar ${uc}`}),this.collapsed=[],this.state.visible=!1}show(){this.viewer.container.classList.add(`psv--has-navbar`),this.container.classList.add(`psv-navbar--open`),this.state.visible=!0}hide(){this.viewer.container.classList.remove(`psv--has-navbar`),this.container.classList.remove(`psv-navbar--open`),this.state.visible=!1}setButtons(e){this.children.slice().forEach(e=>e.destroy()),this.children.length=0,e.indexOf(kd.id)!==-1&&e.indexOf(od.id)===-1&&e.splice(e.indexOf(kd.id),0,od.id),e.forEach(e=>{typeof e==`object`?new ad(this,e):Ad[e]?new Ad[e](this):jd[e]?jd[e].forEach(e=>{new e(this)}):el(`Unknown button ${e}`)}),new dd(this),this.children.forEach(e=>{e instanceof id&&e.checkSupported()}),this.autoSize()}setCaption(e){this.children.some(t=>t instanceof kd?(t.setCaption(e),!0):!1)}getButton(e,t=!0){let n=this.children.find(t=>t instanceof id&&t.id===e);return!n&&t&&el(`button "${e}" not found in the navbar`),n}focusButton(e){this.isVisible()&&(this.getButton(e,!1)?.container||this.container.firstElementChild)?.focus()}autoSize(){this.children.forEach(e=>{e instanceof id&&e.autoSize()});let e=this.container.offsetWidth,t=0,n=[];this.children.forEach(e=>{e.isVisible()&&e instanceof id&&(t+=e.width,e.collapsable&&n.push(e))}),t!==0&&(e<t&&n.length>0?(n.forEach(e=>e.collapse()),this.collapsed=n,this.getButton(dd.id).show(!1)):e>=t&&this.collapsed.length>0&&(this.collapsed.forEach(e=>e.uncollapse()),this.collapsed=[],this.getButton(dd.id).hide(!1)),this.getButton(kd.id,!1)?.autoSize())}};Vr.enabled=!1;var Pd={enabled:!0,maxItems:10,ttl:600,items:{},purgeInterval:null,init(){Vr.enabled&&=(el(`ThreeJS cache should be disabled`),!1),!this.purgeInterval&&this.enabled&&(this.purgeInterval=setInterval(()=>this.purge(),60*1e3))},add(e,t,n){this.enabled&&t&&(this.items[t]=this.items[t]??{files:{},lastAccess:null},this.items[t].files[e]=n,this.items[t].lastAccess=Date.now())},get(e,t){if(this.enabled&&t&&this.items[t])return this.items[t].lastAccess=Date.now(),this.items[t].files[e]},remove(e,t){this.enabled&&t&&this.items[t]&&(delete this.items[t].files[e],Object.keys(this.items[t].files).length===0&&delete this.items[t])},purge(){Object.entries(this.items).sort(([,e],[,t])=>t.lastAccess-e.lastAccess).forEach(([e,{lastAccess:t}],n)=>{n>0&&(Date.now()-t>=this.ttl*1e3||n>=this.maxItems)&&delete this.items[e]})}},Fd=class extends nd{constructor(e){super(e,{className:`psv-loader-container`}),this.loader=document.createElement(`div`),this.loader.className=`psv-loader`,this.container.appendChild(this.loader),this.size=this.loader.offsetWidth,this.canvas=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`),this.canvas.setAttribute(`class`,`psv-loader-canvas`),this.canvas.setAttribute(`viewBox`,`0 0 ${this.size} ${this.size}`),this.loader.appendChild(this.canvas),this.textColor=Nc(this.loader,`color`),this.color=Nc(this.canvas,`color`),this.border=parseInt(Nc(this.loader,`--psv-loader-border`),10),this.thickness=parseInt(Nc(this.loader,`--psv-loader-tickness`),10);let t=this.size/2;this.canvas.innerHTML=`
            <circle cx="${t}" cy="${t}" r="${t}" fill="${this.color}"/>
            <path d="" fill="none" stroke="${this.textColor}" stroke-width="${this.thickness}" stroke-linecap="round"/>
        `,this.viewer.addEventListener(ql.type,this),this.__updateContent(),this.hide()}destroy(){this.viewer.removeEventListener(ql.type,this),super.destroy()}handleEvent(e){e instanceof ql&&e.containsOptions(`loadingImg`,`loadingTxt`,`lang`)&&this.__updateContent()}setProgress(e){this.container.classList.remove(`psv-loader--undefined`);let t=B.clamp(e,0,99.999)/100*Math.PI*2,n=this.size/2,r=n,i=this.thickness/2+this.border,a=(this.size-this.thickness)/2-this.border,o=Math.sin(t)*a+n,s=-Math.cos(t)*a+n,c=e>50?`1`:`0`;this.canvas.querySelector(`path`).setAttributeNS(null,`d`,`M ${r} ${i} A ${a} ${a} 0 ${c} 1 ${o} ${s}`)}showUndefined(){this.show(),this.setProgress(25),this.container.classList.add(`psv-loader--undefined`)}__updateContent(){let e=this.loader.querySelector(`.psv-loader-image, .psv-loader-text`);e&&this.loader.removeChild(e);let t;if(this.viewer.config.loadingImg?(t=document.createElement(`img`),t.className=`psv-loader-image`,t.src=this.viewer.config.loadingImg):this.viewer.config.loadingTxt!==null&&(t=document.createElement(`div`),t.className=`psv-loader-text`,t.innerHTML=this.viewer.config.loadingTxt||this.viewer.config.lang.loading),t){let e=Math.round(Math.sqrt(2*(this.size/2-this.thickness/2-this.border)**2));t.style.maxWidth=e+`px`,t.style.maxHeight=e+`px`,this.loader.appendChild(t)}}},Id=class extends nd{constructor(e){super(e,{className:`psv-notification`}),this.state={visible:!1,contentId:null,timeout:null},this.content=document.createElement(`div`),this.content.className=`psv-notification-content`,this.container.appendChild(this.content),this.content.addEventListener(`click`,()=>this.hide())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new $(`Notification cannot be toggled`)}show(e){this.state.timeout&&(clearTimeout(this.state.timeout),this.state.timeout=null),typeof e==`string`&&(e={content:e}),this.state.contentId=e.id||null,this.content.innerHTML=e.content,this.container.classList.add(`psv-notification--visible`),this.state.visible=!0,this.viewer.dispatchEvent(new Du(this.state.contentId)),e.timeout&&(this.state.timeout=setTimeout(()=>this.hide(this.state.contentId),e.timeout))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.container.classList.remove(`psv-notification--visible`),this.state.visible=!1,this.state.contentId=null,this.viewer.dispatchEvent(new $l(e))}}},Ld=class extends nd{constructor(e){super(e,{className:`psv-overlay ${uc}`}),this.state={visible:!1,contentId:null,dismissible:!0},this.image=document.createElement(`div`),this.image.className=`psv-overlay-image`,this.container.appendChild(this.image),this.title=document.createElement(`div`),this.title.className=`psv-overlay-title`,this.container.appendChild(this.title),this.text=document.createElement(`div`),this.text.className=`psv-overlay-text`,this.container.appendChild(this.text),this.container.addEventListener(`click`,this),this.viewer.addEventListener(su.type,this),super.hide()}destroy(){this.viewer.removeEventListener(su.type,this),super.destroy()}handleEvent(e){e.type===`click`?this.isVisible()&&this.state.dismissible&&(this.hide(),e.stopPropagation()):e instanceof su&&this.isVisible()&&this.state.dismissible&&e.matches(pc.Escape)&&(this.hide(),e.preventDefault())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new $(`Overlay cannot be toggled`)}show(e){typeof e==`string`&&(e={title:e}),this.state.contentId=e.id||null,this.state.dismissible=e.dismissible!==!1,this.image.innerHTML=e.image||``,this.title.innerHTML=e.title||``,this.text.innerHTML=e.text||``,super.show(),this.viewer.dispatchEvent(new ku(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;super.hide(),this.state.contentId=null,this.viewer.dispatchEvent(new tu(e))}}},Rd=200,zd=`psv-panel-content--no-interaction`,Bd=class extends nd{constructor(e){super(e,{className:`psv-panel ${uc}`}),this.state={visible:!1,contentId:null,mouseX:0,mouseY:0,mousedown:!1,clickHandler:null,keyHandler:null,width:{}};let t=document.createElement(`div`);t.className=`psv-panel-resizer`,this.container.appendChild(t);let n=document.createElement(`div`);n.className=`psv-panel-close-button`,n.innerHTML=mc.close,n.title=e.config.lang.close,this.container.appendChild(n),this.content=document.createElement(`div`),this.content.className=`psv-panel-content`,this.container.appendChild(this.content),n.addEventListener(`click`,()=>this.hide()),t.addEventListener(`mousedown`,this),t.addEventListener(`touchstart`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this),this.viewer.container.addEventListener(`mousemove`,this),this.viewer.container.addEventListener(`touchmove`,this),this.viewer.addEventListener(su.type,this)}destroy(){this.viewer.removeEventListener(su.type,this),this.viewer.container.removeEventListener(`mousemove`,this),this.viewer.container.removeEventListener(`touchmove`,this),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`mousemove`:this.__onMouseMove(e);break;case`touchmove`:this.__onTouchMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchend`:this.__onTouchEnd(e);break;case su.type:this.__onKeyPress(e);break}}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new $(`Panel cannot be toggled`)}show(e){typeof e==`string`&&(e={content:e});let t=this.isVisible(e.id);this.state.contentId=e.id||null,this.state.visible=!0,this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),e.id&&this.state.width[e.id]?this.container.style.width=this.state.width[e.id]:e.width?this.container.style.width=e.width:this.container.style.width=null,this.content.innerHTML=e.content,this.content.scrollTop=0,this.container.classList.add(`psv-panel--open`),Tc(this.content,`psv-panel-content--no-margin`,e.noMargin===!0),e.clickHandler&&(this.state.clickHandler=t=>{e.clickHandler(Ac(t))},this.state.keyHandler=t=>{t.key===pc.Enter&&e.clickHandler(Ac(t))},this.content.addEventListener(`click`,this.state.clickHandler),this.content.addEventListener(`keydown`,this.state.keyHandler),t||setTimeout(()=>{this.content.querySelector(`a,button,[tabindex]`)?.focus()},300)),this.viewer.dispatchEvent(new ju(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.state.visible=!1,this.state.contentId=null,this.content.innerHTML=null,this.container.classList.remove(`psv-panel--open`),this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),this.viewer.dispatchEvent(new ru(e))}}__onMouseDown(e){e.stopPropagation(),this.__startResize(e.clientX,e.clientY)}__onTouchStart(e){if(e.stopPropagation(),e.touches.length===1){let t=e.touches[0];this.__startResize(t.clientX,t.clientY)}}__onMouseUp(e){this.state.mousedown&&(e.stopPropagation(),this.state.mousedown=!1,this.content.classList.remove(zd))}__onTouchEnd(e){this.state.mousedown&&(e.stopPropagation(),e.touches.length===0&&(this.state.mousedown=!1,this.content.classList.remove(zd)))}__onMouseMove(e){this.state.mousedown&&(e.stopPropagation(),this.__resize(e.clientX,e.clientY))}__onTouchMove(e){if(this.state.mousedown){let t=e.touches[0];this.__resize(t.clientX,t.clientY)}}__onKeyPress(e){this.isVisible()&&e.matches(pc.Escape)&&(this.hide(),e.preventDefault())}__startResize(e,t){this.state.mouseX=e,this.state.mouseY=t,this.state.mousedown=!0,this.content.classList.add(zd)}__resize(e,t){let n=e,r=t,i=Math.max(Rd,this.container.offsetWidth-(n-this.state.mouseX))+`px`;this.state.contentId&&(this.state.width[this.state.contentId]=i),this.container.style.width=i,this.state.mouseX=n,this.state.mouseY=r}},Vd=class extends nd{constructor(e,t){super(e,{className:`psv-tooltip`}),this.state={visible:!0,arrow:0,border:0,state:0,width:0,height:0,pos:``,config:null,data:null,hideTimeout:null},this.content=document.createElement(`div`),this.content.className=`psv-tooltip-content`,this.container.appendChild(this.content),this.arrow=document.createElement(`div`),this.arrow.className=`psv-tooltip-arrow`,this.container.appendChild(this.arrow),this.container.addEventListener(`transitionend`,this),this.container.addEventListener(`touchdown`,e=>e.stopPropagation()),this.container.addEventListener(`mousedown`,e=>e.stopPropagation()),this.container.style.top=`-1000px`,this.container.style.left=`-1000px`,this.show(t)}handleEvent(e){e.type===`transitionend`&&this.__onTransitionEnd(e)}destroy(){clearTimeout(this.state.hideTimeout),delete this.state.data,super.destroy()}toggle(){throw new $(`Tooltip cannot be toggled`)}show(e){if(this.state.state!==0)throw new $(`Initialized tooltip cannot be re-initialized`);e.className&&Ec(this.container,e.className),e.style&&Object.assign(this.container.style,e.style),this.state.state=3,this.update(e.content,e),this.state.data=e.data,this.state.state=1,this.viewer.dispatchEvent(new Nu(this,this.state.data)),this.__waitImages()}update(e,t){this.content.innerHTML=e;let n=this.container.getBoundingClientRect();this.state.width=n.right-n.left,this.state.height=n.bottom-n.top,this.state.arrow=parseInt(Nc(this.arrow,`border-top-width`),10),this.state.border=parseInt(Nc(this.container,`border-top-left-radius`),10),this.move(t??this.state.config),this.__waitImages()}move(e){if(this.state.state!==1&&this.state.state!==3)throw new $(`Uninitialized tooltip cannot be moved`);e.box=e.box??this.state.config?.box??{width:0,height:0},this.state.config=e;let t=this.container,n=this.arrow,r={posClass:ll(e.position,{allowCenter:!1,cssOrder:!1})||[`top`,`center`],width:this.state.width,height:this.state.height,top:0,left:0,arrowTop:0,arrowLeft:0};this.__computeTooltipPosition(r,e);let i=null,a=null;if(r.top<0?i=`bottom`:r.top+r.height>this.viewer.state.size.height&&(i=`top`),r.left<0?a=`right`:r.left+r.width>this.viewer.state.size.width&&(a=`left`),a||i){let t=ul(r.posClass);i&&(r.posClass[+!t]=i),a&&(r.posClass[+!!t]=a),this.__computeTooltipPosition(r,e)}t.style.top=r.top+`px`,t.style.left=r.left+`px`,n.style.top=r.arrowTop+`px`,n.style.left=r.arrowLeft+`px`;let o=r.posClass.join(`-`);o!==this.state.pos&&(t.classList.remove(`psv-tooltip--${this.state.pos}`),this.state.pos=o,t.classList.add(`psv-tooltip--${this.state.pos}`))}hide(){this.container.classList.remove(`psv-tooltip--visible`),this.state.state=2,this.viewer.dispatchEvent(new au(this.state.data));let e=parseFloat(Nc(this.container,`transition-duration`));this.state.hideTimeout=setTimeout(()=>{this.destroy()},e*2)}__onTransitionEnd(e){if(e.propertyName===`transform`)switch(this.state.state){case 1:this.container.classList.add(`psv-tooltip--visible`),this.state.state=3;break;case 2:this.state.state=0,this.destroy();break;default:}}__computeTooltipPosition(e,t){let n=this.state.arrow,r=t.top,i=e.height,a=t.left,o=e.width,s=n+this.state.border,c=t.box.width/2+n*2,l=t.box.height/2+n*2;switch(e.posClass.join(`-`)){case`top-left`:e.top=r-l-i,e.left=a+s-o,e.arrowTop=i,e.arrowLeft=o-s-n;break;case`top-center`:e.top=r-l-i,e.left=a-o/2,e.arrowTop=i,e.arrowLeft=o/2-n;break;case`top-right`:e.top=r-l-i,e.left=a-s,e.arrowTop=i,e.arrowLeft=n;break;case`bottom-left`:e.top=r+l,e.left=a+s-o,e.arrowTop=-n*2,e.arrowLeft=o-s-n;break;case`bottom-center`:e.top=r+l,e.left=a-o/2,e.arrowTop=-n*2,e.arrowLeft=o/2-n;break;case`bottom-right`:e.top=r+l,e.left=a-s,e.arrowTop=-n*2,e.arrowLeft=n;break;case`left-top`:e.top=r+s-i,e.left=a-c-o,e.arrowTop=i-s-n,e.arrowLeft=o;break;case`center-left`:e.top=r-i/2,e.left=a-c-o,e.arrowTop=i/2-n,e.arrowLeft=o;break;case`left-bottom`:e.top=r-s,e.left=a-c-o,e.arrowTop=n,e.arrowLeft=o;break;case`right-top`:e.top=r+s-i,e.left=a+c,e.arrowTop=i-s-n,e.arrowLeft=-n*2;break;case`center-right`:e.top=r-i/2,e.left=a+c,e.arrowTop=i/2-n,e.arrowLeft=-n*2;break;case`right-bottom`:e.top=r-s,e.left=a+c,e.arrowTop=n,e.arrowLeft=-n*2;break}}__waitImages(){let e=this.content.querySelectorAll(`img`);if(e.length>0){let t=[];e.forEach(e=>{e.complete||t.push(new Promise(t=>{e.onload=t,e.onerror=t}))}),t.length&&Promise.all(t).then(()=>{if(this.state.state===1||this.state.state===3){let e=this.container.getBoundingClientRect();this.state.width=e.right-e.left,this.state.height=e.bottom-e.top,this.move(this.state.config)}})}}},Hd=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70"><path fill="currentColor" d="M50,16.2c-18.6,0-33.8,15.1-33.8,33.8S31.4,83.7,50,83.7S83.8,68.6,83.8,50S68.6,16.2,50,16.2z M50,80.2c-16.7,0-30.2-13.6-30.2-30.2S33.3,19.7,50,19.7S80.3,33.3,80.3,50S66.7,80.2,50,80.2z"/><rect fill="currentColor" x="48" y="31.7" width="4" height="28"/><rect fill="currentColor" x="48" y="63.2" width="4" height="5"/><!--Created by Shastry from the Noun Project--></svg>
`,Ud=class{constructor(e){this.viewer=e,this.config=e.config,this.state=e.state}destroy(){}},Wd=new H,Gd=new ot(0,0,0,`ZXY`),Kd=class extends Ud{constructor(e){super(e)}fovToZoomLevel(e){let t=Math.round((e-this.config.minFov)/(this.config.maxFov-this.config.minFov)*100);return B.clamp(t-2*(t-50),0,100)}zoomLevelToFov(e){return this.config.maxFov+e/100*(this.config.minFov-this.config.maxFov)}vFovToHFov(e){return B.radToDeg(2*Math.atan(Math.tan(B.degToRad(e)/2)*this.state.aspect))}hFovToVFov(e){return B.radToDeg(2*Math.atan(Math.tan(B.degToRad(e)/2)/this.state.aspect))}getAnimationProperties(e,t,n){let r=!Kc(t),i=!Kc(n),a={},o=null;if(r){let n=this.viewer.getPosition(),r=xc(n.yaw,t.yaw);a.yaw={start:n.yaw,end:n.yaw+r},a.pitch={start:n.pitch,end:t.pitch},o=fl(e,Sc(n,t))}if(i){let t=this.viewer.getZoomLevel(),r=Math.abs(n-t);a.zoom={start:t,end:n},o===null&&(o=fl(e,Math.PI/4*r/100))}return o=o===null?typeof e==`number`?e:nc:Math.max(nc,o),{duration:o,properties:a}}getTransitionOptions(e){let t,n=this.config.defaultTransition??Td.defaultTransition;return t=e.transition===!1||e.transition===null?null:e.transition===!0?{...n}:typeof e.transition==`object`?{...n,...e.transition}:this.config.defaultTransition,t}textureCoordsToSphericalCoords(e){if(!this.state.textureData?.panoData)throw new $(`Current adapter does not support texture coordinates or no texture has been loaded`);let t=this.viewer.adapter.textureCoordsToSphericalCoords(e,this.state.textureData.panoData);return!Gd.equals(this.viewer.renderer.panoramaPose)||!Gd.equals(this.viewer.renderer.sphereCorrection)?(this.sphericalCoordsToVector3(t,Wd),Wd.applyEuler(this.viewer.renderer.panoramaPose),Wd.applyEuler(this.viewer.renderer.sphereCorrection),this.vector3ToSphericalCoords(Wd)):t}sphericalCoordsToTextureCoords(e){if(!this.state.textureData?.panoData)throw new $(`Current adapter does not support texture coordinates or no texture has been loaded`);return(!Gd.equals(this.viewer.renderer.panoramaPose)||!Gd.equals(this.viewer.renderer.sphereCorrection))&&(this.sphericalCoordsToVector3(e,Wd),Dl(Wd,this.viewer.renderer.sphereCorrection),Dl(Wd,this.viewer.renderer.panoramaPose),e=this.vector3ToSphericalCoords(Wd)),this.viewer.adapter.sphericalCoordsToTextureCoords(e,this.state.textureData.panoData)}sphericalCoordsToVector3(e,t,n=cc){return t||=new H,t.x=n*-Math.cos(e.pitch)*Math.sin(e.yaw),t.y=n*Math.sin(e.pitch),t.z=n*Math.cos(e.pitch)*Math.cos(e.yaw),t}vector3ToSphericalCoords(e){let t=Math.acos(e.y/Math.sqrt(e.x*e.x+e.y*e.y+e.z*e.z)),n=Math.atan2(e.x,e.z);return{yaw:n<0?-n:Math.PI*2-n,pitch:Math.PI/2-t}}viewerCoordsToVector3(e){let t=this.viewer.renderer.getIntersections(e).filter(e=>e.object.userData[lc]);return t.length?t[0].point:null}viewerCoordsToSphericalCoords(e){let t=this.viewerCoordsToVector3(e);return t?this.vector3ToSphericalCoords(t):null}vector3ToViewerCoords(e){let t=e.clone();return t.project(this.viewer.renderer.camera),{x:Math.round((t.x+1)/2*this.state.size.width),y:Math.round((1-t.y)/2*this.state.size.height)}}sphericalCoordsToViewerCoords(e){return this.sphericalCoordsToVector3(e,Wd),this.vector3ToViewerCoords(Wd)}isPointVisible(e){let t,n;if(e instanceof H)t=e,n=this.vector3ToViewerCoords(e);else if(tl(e))t=this.sphericalCoordsToVector3(e,Wd),n=this.vector3ToViewerCoords(t);else return!1;return t.dot(this.viewer.state.direction)>0&&n.x>=0&&n.x<=this.viewer.state.size.width&&n.y>=0&&n.y<=this.viewer.state.size.height}cleanPosition(e){if(`yaw`in e||`pitch`in e){if(!(`yaw`in e)||!(`pitch`in e))throw new $(`Position is missing 'yaw' or 'pitch'`);return{yaw:pl(e.yaw),pitch:pl(e.pitch,!0)}}else return this.textureCoordsToSphericalCoords(e)}cleanSphereCorrection(e){return{pan:pl(e?.pan||0),tilt:pl(e?.tilt||0,!0),roll:pl(e?.roll||0,!0,!1)}}cleanPanoramaPose(e){return{pan:B.degToRad(e?.poseHeading||0),tilt:B.degToRad(e?.posePitch||0),roll:B.degToRad(e?.poseRoll||0)}}cleanPanoramaOptions(e,t){return t?.isEquirectangular?(Kc(e.zoom)&&!Kc(t.initialFov)&&(e={...e,zoom:this.fovToZoomLevel(this.hFovToVFov(t.initialFov))}),Kc(e.position)&&!Kc(t.initialHeading)&&!Kc(t.initialPitch)&&(e={...e,position:{yaw:B.degToRad(t.initialHeading),pitch:B.degToRad(t.initialPitch)}}),e):e}},qd=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="currentColor" d="M33.38 33.2a1.96 1.96 0 0 0 1.5-3.23 10.61 10.61 0 0 1 7.18-17.51c.7-.06 1.31-.49 1.61-1.12a13.02 13.02 0 0 1 11.74-7.43c7.14 0 12.96 5.8 12.96 12.9 0 3.07-1.1 6.05-3.1 8.38-.7.82-.61 2.05.21 2.76.83.7 2.07.6 2.78-.22a16.77 16.77 0 0 0 4.04-10.91C72.3 7.54 64.72 0 55.4 0a16.98 16.98 0 0 0-14.79 8.7 14.6 14.6 0 0 0-12.23 14.36c0 3.46 1.25 6.82 3.5 9.45.4.45.94.69 1.5.69m45.74 43.55a22.13 22.13 0 0 1-5.23 12.4c-4 4.55-9.53 6.86-16.42 6.86-12.6 0-20.1-10.8-20.17-10.91a1.82 1.82 0 0 0-.08-.1c-5.3-6.83-14.55-23.82-17.27-28.87-.05-.1 0-.21.02-.23a6.3 6.3 0 0 1 8.24 1.85l9.38 12.59a1.97 1.97 0 0 0 3.54-1.17V25.34a4 4 0 0 1 1.19-2.87 3.32 3.32 0 0 1 2.4-.95c1.88.05 3.4 1.82 3.4 3.94v24.32a1.96 1.96 0 0 0 3.93 0v-33.1a3.5 3.5 0 0 1 7 0v35.39a1.96 1.96 0 0 0 3.93 0v-.44c.05-2.05 1.6-3.7 3.49-3.7 1.93 0 3.5 1.7 3.5 3.82v5.63c0 .24.04.48.13.71l.1.26a1.97 1.97 0 0 0 3.76-.37c.33-1.78 1.77-3.07 3.43-3.07 1.9 0 3.45 1.67 3.5 3.74l-1.77 18.1zM77.39 51c-1.25 0-2.45.32-3.5.9v-.15c0-4.27-3.33-7.74-7.42-7.74-1.26 0-2.45.33-3.5.9V16.69a7.42 7.42 0 0 0-14.85 0v1.86a7 7 0 0 0-3.28-.94 7.21 7.21 0 0 0-5.26 2.07 7.92 7.92 0 0 0-2.38 5.67v37.9l-5.83-7.82a10.2 10.2 0 0 0-13.35-2.92 4.1 4.1 0 0 0-1.53 5.48C20 64.52 28.74 80.45 34.07 87.34c.72 1.04 9.02 12.59 23.4 12.59 7.96 0 14.66-2.84 19.38-8.2a26.06 26.06 0 0 0 6.18-14.6l1.78-18.2v-.2c0-4.26-3.32-7.73-7.42-7.73z"/><!--Created by AomAm from the Noun Project--></svg>
`,Jd=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="10 17 79 79"><path fill="currentColor" d="M38.1 29.27c-.24 0-.44.2-.44.45v10.7a.45.45 0 00.9 0v-10.7c0-.25-.2-.45-.45-.45zm10.2 26.66a11.54 11.54 0 01-8.48-6.14.45.45 0 10-.8.41 12.45 12.45 0 009.22 6.62.45.45 0 00.07-.9zm24.55-13.08a23.04 23.04 0 00-22.56-23v7.07l-.01.05a2.83 2.83 0 012.39 2.78v14.03l.09-.02h8.84v-9.22a.45.45 0 11.9 0v9.22h10.35v-.9zm0 27.33V44.66H62.5c-.02 2.01-.52 4-1.47 5.76a.45.45 0 01-.61.18.45.45 0 01-.19-.61 11.54 11.54 0 001.36-5.33h-8.83l-.1-.01a2.83 2.83 0 01-2.83 2.84h-.04-.04a2.83 2.83 0 01-2.83-2.83v-14.9a2.82 2.82 0 012.47-2.8v-7.11a23.04 23.04 0 00-22.57 23v.91h14.72V29.88a8.2 8.2 0 015.02-7.57c.22-.1.5.01.59.24.1.23-.01.5-.24.6a7.3 7.3 0 00-4.47 6.73v13.88h3.9a.45.45 0 110 .9h-3.9v.15a7.32 7.32 0 0011.23 6.17.45.45 0 01.49.76 8.22 8.22 0 01-12.62-6.93v-.15H26.82v25.52a23.04 23.04 0 0023.01 23.01 23.04 23.04 0 0023.02-23.01zm1.8-27.33v27.33A24.85 24.85 0 0149.84 95a24.85 24.85 0 01-24.82-24.82V42.85a24.85 24.85 0 0124.82-24.82 24.85 24.85 0 0124.83 24.82zM57.98 29.88v9.36a.45.45 0 11-.9 0v-9.36a7.28 7.28 0 00-3.4-6.17.45.45 0 01.49-.76 8.18 8.18 0 013.8 6.93z"/><!-- Created by Icon Island from the Noun Project --></svg>
`,Yd=class e{constructor(){this.$=e.IDLE}is(...e){return e.some(e=>this.$&e)}set(e){this.$=e}add(e){this.$|=e}remove(e){this.$&=~e}};Yd.IDLE=0,Yd.CLICK=1,Yd.MOVING=2;var Xd=Yd,Zd=class extends Ud{constructor(e){super(e),this.data={startMouseX:0,startMouseY:0,mouseX:0,mouseY:0,pinchDist:0,moveDelta:{yaw:0,pitch:0,zoom:0},accumulatorFactor:0,ctrlKeyDown:!1,dblclickData:null,dblclickTimeout:null,longtouchTimeout:null,twofingersTimeout:null,ctrlZoomTimeout:null},this.step=new Xd,this.keyHandler=new jl,this.resizeObserver=new ResizeObserver(Vc(()=>this.viewer.autoSize(),50)),this.moveThreshold=rc*bl.pixelRatio}init(){window.addEventListener(`keydown`,this,{passive:!1}),window.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mousedown`,this),window.addEventListener(`mousemove`,this,{passive:!1}),window.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchstart`,this,{passive:!1}),window.addEventListener(`touchmove`,this,{passive:!1}),window.addEventListener(`touchend`,this,{passive:!1}),this.viewer.container.addEventListener(`wheel`,this,{passive:!1}),document.addEventListener(`fullscreenchange`,this),this.resizeObserver.observe(this.viewer.container),this.viewer.addEventListener(Vl.type,this),this.viewer.addEventListener(Lu.type,this)}destroy(){window.removeEventListener(`keydown`,this),window.removeEventListener(`keyup`,this),this.viewer.container.removeEventListener(`mousedown`,this),window.removeEventListener(`mousemove`,this),window.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchstart`,this),window.removeEventListener(`touchmove`,this),window.removeEventListener(`touchend`,this),this.viewer.container.removeEventListener(`wheel`,this),document.removeEventListener(`fullscreenchange`,this),this.resizeObserver.disconnect(),this.viewer.removeEventListener(Vl.type,this),this.viewer.removeEventListener(Lu.type,this),clearTimeout(this.data.dblclickTimeout),clearTimeout(this.data.longtouchTimeout),clearTimeout(this.data.twofingersTimeout),clearTimeout(this.data.ctrlZoomTimeout),super.destroy()}handleEvent(e){switch(e.type){case`keydown`:this.__onKeyDown(e);break;case`keyup`:this.__onKeyUp();break;case`mousemove`:this.__onMouseMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchmove`:this.__onTouchMove(e);break;case`touchend`:this.__onTouchEnd(e);break;case`fullscreenchange`:this.__onFullscreenChange();break;case Vl.type:this.__applyMoveDelta();break;case Lu.type:this.__clearMoveDelta();break}if(!jc(e,`.`+uc))switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`wheel`:this.__onMouseWheel(e);break}}__onKeyDown(e){if(this.config.mousewheelCtrlKey&&(this.data.ctrlKeyDown=e.key===pc.Control,this.data.ctrlKeyDown&&(clearTimeout(this.data.ctrlZoomTimeout),this.viewer.overlay.hide(fc.CTRL_ZOOM))),this.viewer.dispatchEvent(new su(e.key,e))&&!(!this.state.keyboardEnabled||!this.config.keyboardActions||this.keyHandler.pending)){for(let[t,n]of Object.entries(this.config.keyboardActions))if(zc(e,t)){if(typeof n==`function`)n(this.viewer,e);else{switch(n!==`ZOOM_IN`&&n!==`ZOOM_OUT`&&this.viewer.stopAll(),n){case`ROTATE_UP`:this.viewer.dynamics.position.roll({pitch:!1});break;case`ROTATE_DOWN`:this.viewer.dynamics.position.roll({pitch:!0});break;case`ROTATE_RIGHT`:this.viewer.dynamics.position.roll({yaw:!1});break;case`ROTATE_LEFT`:this.viewer.dynamics.position.roll({yaw:!0});break;case`ZOOM_IN`:this.viewer.dynamics.zoom.roll(!1);break;case`ZOOM_OUT`:this.viewer.dynamics.zoom.roll(!0);break}this.keyHandler.down(n)}e.preventDefault();return}}}__onKeyUp(){this.data.ctrlKeyDown=!1,this.state.keyboardEnabled&&this.keyHandler.up(e=>{e===`ZOOM_IN`||e===`ZOOM_OUT`?this.viewer.dynamics.zoom.stop():(this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer())})}__onMouseDown(e){this.step.add(Xd.CLICK),this.data.startMouseX=e.clientX,this.data.startMouseY=e.clientY,this.config.mousemove&&e.preventDefault()}__onMouseUp(e){this.step.is(Xd.CLICK,Xd.MOVING)&&this.__stopMove(e.clientX,e.clientY,e,e.button===2)}__onMouseMove(e){this.config.mousemove&&this.step.is(Xd.CLICK,Xd.MOVING)&&(e.preventDefault(),this.__doMove(e.clientX,e.clientY)),this.__handleObjectsEvents(e)}__onTouchStart(e){e.touches.length===1?(this.step.add(Xd.CLICK),this.data.startMouseX=e.touches[0].clientX,this.data.startMouseY=e.touches[0].clientY,this.data.longtouchTimeout||(this.data.longtouchTimeout=setTimeout(()=>{let t=e.touches[0];this.__stopMove(t.clientX,t.clientY,e,!0),this.data.longtouchTimeout=null},ac))):e.touches.length===2&&(this.step.set(Xd.IDLE),this.__cancelLongTouch(),this.config.mousemove&&(this.__cancelTwoFingersOverlay(),this.__startMoveZoom(e),e.preventDefault()))}__onTouchEnd(e){if(this.__cancelLongTouch(),this.step.is(Xd.CLICK,Xd.MOVING)){if(e.preventDefault(),this.__cancelTwoFingersOverlay(),e.touches.length===1)this.__stopMove(this.data.mouseX,this.data.mouseY);else if(e.touches.length===0){let t=e.changedTouches[0];this.__stopMove(t.clientX,t.clientY,e)}}}__onTouchMove(e){if(this.__cancelLongTouch(),this.config.mousemove)if(e.touches.length===1){if(this.config.touchmoveTwoFingers)this.step.is(Xd.CLICK)&&!this.data.twofingersTimeout&&(this.data.twofingersTimeout=setTimeout(()=>{this.viewer.overlay.show({id:fc.TWO_FINGERS,image:qd,title:this.config.lang.twoFingers})},oc));else if(this.step.is(Xd.CLICK,Xd.MOVING)){e.preventDefault();let t=e.touches[0];this.__doMove(t.clientX,t.clientY)}}else this.__doMoveZoom(e),this.__cancelTwoFingersOverlay()}__cancelLongTouch(){this.data.longtouchTimeout&&(clearTimeout(this.data.longtouchTimeout),this.data.longtouchTimeout=null)}__cancelTwoFingersOverlay(){this.config.touchmoveTwoFingers&&(this.data.twofingersTimeout&&(clearTimeout(this.data.twofingersTimeout),this.data.twofingersTimeout=null),this.viewer.overlay.hide(fc.TWO_FINGERS))}__onMouseWheel(e){if(!this.config.mousewheel||!e.deltaY)return;if(this.config.mousewheelCtrlKey&&!this.data.ctrlKeyDown){this.viewer.overlay.show({id:fc.CTRL_ZOOM,image:Jd,title:this.config.lang.ctrlZoom}),clearTimeout(this.data.ctrlZoomTimeout),this.data.ctrlZoomTimeout=setTimeout(()=>this.viewer.overlay.hide(fc.CTRL_ZOOM),sc);return}e.preventDefault(),e.stopPropagation();let t=e.deltaY/Math.abs(e.deltaY)*5*this.config.zoomSpeed;t!==0&&this.viewer.dynamics.zoom.step(-t,5)}__onFullscreenChange(){let e=this.viewer.isFullscreenEnabled();this.config.keyboard===`fullscreen`&&(e?this.viewer.startKeyboardControl():this.viewer.stopKeyboardControl()),this.viewer.dispatchEvent(new Zl(e))}__resetMove(){this.step.set(Xd.IDLE),this.data.mouseX=0,this.data.mouseY=0,this.data.startMouseX=0,this.data.startMouseY=0}__startMoveZoom(e){this.viewer.stopAll(),this.__resetMove();let t=Pc(e);this.step.set(Xd.MOVING),this.data.accumulatorFactor=this.config.moveInertia,{distance:this.data.pinchDist,center:{x:this.data.mouseX,y:this.data.mouseY}}=t}__stopMove(e,t,n,r=!1){this.step.is(Xd.CLICK)&&!this.__moveThresholdReached(e,t)&&this.__doClick(e,t,n,r),this.config.moveInertia&&(this.data.accumulatorFactor=this.config.moveInertia**.5),this.__resetMove(),this.viewer.resetIdleTimer()}__doClick(e,t,n,r=!1){let i=this.viewer.container.getBoundingClientRect(),a=e-i.left,o=t-i.top,s=this.viewer.renderer.getIntersections({x:a,y:o}),c=s.find(e=>e.object.userData[lc]);if(c){let i=this.viewer.dataHelper.vector3ToSphericalCoords(c.point),l={rightclick:r,originalEvent:n,target:Ac(n),clientX:e,clientY:t,viewerX:a,viewerY:o,yaw:i.yaw,pitch:i.pitch,objects:s.map(e=>e.object).filter(e=>!e.userData[lc])};try{let e=this.viewer.dataHelper.sphericalCoordsToTextureCoords(l);Object.assign(l,e)}catch{}this.data.dblclickTimeout?(Math.abs(this.data.dblclickData.clientX-l.clientX)<this.moveThreshold&&Math.abs(this.data.dblclickData.clientY-l.clientY)<this.moveThreshold&&this.viewer.dispatchEvent(new Yl(this.data.dblclickData)),clearTimeout(this.data.dblclickTimeout),this.data.dblclickTimeout=null,this.data.dblclickData=null):(this.viewer.dispatchEvent(new Gl(l)),this.data.dblclickData=Wc(l),this.data.dblclickTimeout=setTimeout(()=>{this.data.dblclickTimeout=null,this.data.dblclickData=null},ic))}}__handleObjectsEvents(e){if(!Gc(this.state.objectsObservers)&&e.composedPath().includes(this.viewer.container)){let t=Mc(this.viewer.container),n={x:e.clientX-t.x,y:e.clientY-t.y},r=this.viewer.renderer.getIntersections(n),i=(t,r,i)=>{this.viewer.dispatchEvent(new i(e,t,n,r))};for(let[e,t]of Object.entries(this.state.objectsObservers)){let n=r.find(t=>t.object.userData[e]);n?(t&&n.object!==t&&(i(t,e,Wu),this.state.objectsObservers[e]=null),t?i(n.object,e,Ku):(this.state.objectsObservers[e]=n.object,i(n.object,e,Hu))):t&&(i(t,e,Wu),this.state.objectsObservers[e]=null)}}}__doMove(e,t){if(this.step.is(Xd.CLICK)&&this.__moveThresholdReached(e,t))this.viewer.stopAll(),this.__resetMove(),this.step.set(Xd.MOVING),this.data.mouseX=e,this.data.mouseY=t,this.data.accumulatorFactor=this.config.moveInertia;else if(this.step.is(Xd.MOVING)){let n=(e-this.data.mouseX)*Math.cos(this.state.roll)-(t-this.data.mouseY)*Math.sin(this.state.roll),r=(t-this.data.mouseY)*Math.cos(this.state.roll)+(e-this.data.mouseX)*Math.sin(this.state.roll),i={yaw:this.config.moveSpeed*(n/this.state.size.width)*B.degToRad(this.state.hFov),pitch:this.config.moveSpeed*(r/this.state.size.height)*B.degToRad(this.state.vFov)};this.data.moveDelta.yaw+=i.yaw,this.data.moveDelta.pitch+=i.pitch,this.data.mouseX=e,this.data.mouseY=t}}__moveThresholdReached(e,t){return Math.abs(e-this.data.startMouseX)>=this.moveThreshold||Math.abs(t-this.data.startMouseY)>=this.moveThreshold}__doMoveZoom(e){if(this.step.is(Xd.MOVING)){e.preventDefault();let t=Pc(e);this.__doMove(t.center.x,t.center.y),this.data.moveDelta.zoom+=this.config.zoomSpeed*((t.distance-this.data.pinchDist)/bl.pixelRatio),this.data.pinchDist=t.distance}}__applyMoveDelta(){let e=.001;if(Math.abs(this.data.moveDelta.yaw)>0||Math.abs(this.data.moveDelta.pitch)>0){let t=this.viewer.getPosition();this.viewer.rotate({yaw:t.yaw-this.data.moveDelta.yaw*(1-this.config.moveInertia),pitch:t.pitch+this.data.moveDelta.pitch*(1-this.config.moveInertia)}),this.data.moveDelta.yaw*=this.data.accumulatorFactor,this.data.moveDelta.pitch*=this.data.accumulatorFactor,Math.abs(this.data.moveDelta.yaw)<=e&&(this.data.moveDelta.yaw=0),Math.abs(this.data.moveDelta.pitch)<=e&&(this.data.moveDelta.pitch=0)}if(Math.abs(this.data.moveDelta.zoom)>0){let t=this.viewer.getZoomLevel();this.viewer.zoom(t+this.data.moveDelta.zoom*(1-this.config.moveInertia)),this.data.moveDelta.zoom*=this.config.moveInertia,Math.abs(this.data.moveDelta.zoom)<=e&&(this.data.moveDelta.zoom=0)}}__clearMoveDelta(){this.data.moveDelta.yaw=0,this.data.moveDelta.pitch=0,this.data.moveDelta.zoom=0}};q.enabled=!1;var Qd=new V,$d=new Ze,ef=new qt,tf=class extends Ud{constructor(e){super(e),this.frustumNeedsUpdate=!0,this.renderer=new Us(this.config.rendererParameters),this.renderer.setPixelRatio(bl.pixelRatio),this.renderer.outputColorSpace=ee,this.renderer.toneMapping=1,this.renderer.domElement.className=`psv-canvas`,this.renderer.domElement.style.background=this.config.canvasBackground,this.scene=new Mt,this.camera=new ri(50,16/9,.1,2*cc),this.camera.matrixAutoUpdate=!1;let t=new Xn(new mr(cc).scale(-1,1,1),new Rn({opacity:0,transparent:!0,depthTest:!1,depthWrite:!1}));t.userData={[lc]:!0},this.scene.add(t),this.raycaster=new Si,this.frustum=new sr,this.container=document.createElement(`div`),this.container.className=`psv-canvas-container`,this.container.appendChild(this.renderer.domElement),this.viewer.container.appendChild(this.container),this.container.addEventListener(`contextmenu`,e=>e.preventDefault()),this.viewer.addEventListener(Fu.type,this),this.viewer.addEventListener(zu.type,this),this.viewer.addEventListener(yu.type,this),this.viewer.addEventListener(xu.type,this),this.viewer.addEventListener(ql.type,this),this.hide()}get panoramaPose(){return this.mesh.rotation}get sphereCorrection(){return this.meshContainer.rotation}init(){this.show(),this.renderer.setAnimationLoop(e=>this.__renderLoop(e))}destroy(){this.renderer.setAnimationLoop(null),this.cleanScene(this.scene),this.renderer.dispose(),this.viewer.container.removeChild(this.container),this.viewer.removeEventListener(Fu.type,this),this.viewer.removeEventListener(zu.type,this),this.viewer.removeEventListener(yu.type,this),this.viewer.removeEventListener(xu.type,this),this.viewer.removeEventListener(ql.type,this),super.destroy()}handleEvent(e){switch(e.type){case Fu.type:this.__onSizeUpdated();break;case zu.type:this.__onZoomUpdated();break;case yu.type:this.__onPositionUpdated();break;case xu.type:this.__onPositionUpdated();break;case ql.type:e.containsOptions(`fisheye`)&&this.__onPositionUpdated(),e.containsOptions(`canvasBackground`)&&(this.renderer.domElement.style.background=this.config.canvasBackground);break}}hide(){this.container.style.opacity=`0`}show(){this.container.style.opacity=`1`}setCustomRenderer(e){e?this.customRenderer=e(this.renderer):this.customRenderer=null,this.viewer.needsUpdate()}__onSizeUpdated(){this.renderer.setSize(this.state.size.width,this.state.size.height),this.camera.aspect=this.state.aspect,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onZoomUpdated(){this.camera.fov=this.state.vFov,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onPositionUpdated(){this.camera.position.set(0,0,0),this.camera.lookAt(this.state.direction),this.config.fisheye&&this.camera.position.copy(this.state.direction).multiplyScalar(this.config.fisheye/2).negate(),this.camera.rotateZ(-this.state.roll),this.camera.updateMatrix(),this.camera.updateMatrixWorld(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__renderLoop(e){let t=this.timestamp?e-this.timestamp:0;this.timestamp=e,this.viewer.dispatchEvent(new Vl(e,t)),this.viewer.dynamics.update(t),(this.state.needsUpdate||this.state.continuousUpdateCount>0)&&(this.state.needsUpdate=!1,(this.customRenderer||this.renderer).render(this.scene,this.camera),this.viewer.dispatchEvent(new Tu))}setTexture(e){this.meshContainer||(this.meshContainer=new wt,this.scene.add(this.meshContainer)),this.state.textureData&&this.viewer.adapter.disposeTexture(this.state.textureData),this.mesh&&(this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh)),this.mesh=this.viewer.adapter.createMesh(e.panoData),this.viewer.adapter.setTexture(this.mesh,e,!1),this.meshContainer.add(this.mesh),this.state.textureData=e,this.viewer.needsUpdate()}setPanoramaPose(e,t=this.mesh){let n=this.viewer.dataHelper.cleanPanoramaPose(e);t.rotation.set(-n.tilt,-n.pan,n.roll,`YXZ`)}setSphereCorrection(e,t=this.meshContainer){let n=this.viewer.dataHelper.cleanSphereCorrection(e);t.rotation.set(n.tilt,n.pan,n.roll,`YXZ`)}transition(e,t,n){let r=n.effect===`fade`||n.rotation,i=!Kc(t.position),a=!Kc(t.zoom),o=new zl(i?this.viewer.dataHelper.cleanPosition(t.position):void 0,t.zoom);this.viewer.dispatchEvent(o);let s=new wt,c=this.viewer.adapter.createMesh(e.panoData);if(this.viewer.adapter.setTexture(c,e,!0),this.viewer.adapter.setTextureOpacity(c,0),this.setPanoramaPose(e.panoData,c),this.setSphereCorrection(t.sphereCorrection,s),i&&!n.rotation){let e=this.viewer.getPosition(),t=new H(0,1,0);s.rotateOnWorldAxis(t,o.position.yaw-e.yaw);let n=new H(0,1,0).cross(this.camera.getWorldDirection(new H)).normalize();s.rotateOnWorldAxis(n,o.position.pitch-e.pitch)}s.add(c),this.scene.add(s);let l=new Je;this.renderer.setRenderTarget(l),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),l.dispose();let{duration:u,properties:d}=this.viewer.dataHelper.getAnimationProperties(n.speed,n.rotation?o.position:null,r?o.zoomLevel:null),f=new Ol({properties:{...d,opacity:{start:0,end:1}},duration:u,easing:`inOutCubic`,onTick:e=>{switch(n.effect){case`fade`:this.viewer.adapter.setTextureOpacity(c,e.opacity);break;case`black`:case`white`:e.opacity<.5?this.renderer.toneMappingExposure=n.effect===`black`?B.mapLinear(e.opacity,0,.5,1,0):B.mapLinear(e.opacity,0,.5,1,5):(this.renderer.toneMappingExposure=n.effect===`black`?B.mapLinear(e.opacity,.5,1,0,1):B.mapLinear(e.opacity,.5,1,5,1),this.mesh.visible=!1,this.viewer.adapter.setTextureOpacity(c,1),a&&!r&&this.viewer.dynamics.zoom.setValue(o.zoomLevel));break}i&&n.rotation&&this.viewer.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),a&&r&&this.viewer.dynamics.zoom.setValue(e.zoom),this.viewer.needsUpdate()}});return f.then(r=>{s.remove(c),this.scene.remove(s),r?(this.viewer.adapter.disposeTexture(this.state.textureData),this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh),this.mesh=c,this.meshContainer.add(c),this.state.textureData=e,this.setPanoramaPose(e.panoData),this.setSphereCorrection(t.sphereCorrection),i&&!n.rotation&&this.viewer.rotate(t.position)):(this.viewer.adapter.disposeTexture(e),this.viewer.adapter.disposeMesh(c))}),f}getIntersections(e){Qd.x=2*e.x/this.state.size.width-1,Qd.y=-2*e.y/this.state.size.height+1,this.raycaster.setFromCamera(Qd,this.camera);let t=this.raycaster.intersectObjects(this.scene.children,!0).filter(e=>e.object.visible).filter(e=>e.object.isMesh&&!!e.object.userData);return this.customRenderer?.getIntersections&&t.push(...this.customRenderer.getIntersections(this.raycaster,Qd)),t}isObjectVisible(e){if(!e)return!1;if(this.frustumNeedsUpdate&&=($d.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse),this.frustum.setFromProjectionMatrix($d),!1),e.isVector3)return this.frustum.containsPoint(e);if(e.isMesh&&e.geometry){let t=e;return t.geometry.boundingBox||t.geometry.computeBoundingBox(),ef.copy(t.geometry.boundingBox).applyMatrix4(t.matrixWorld),this.frustum.intersectsBox(ef)}else if(e.isObject3D)return this.frustum.intersectsObject(e);else return!1}addObject(e){this.scene.add(e)}removeObject(e){this.scene.remove(e)}cleanScene(e){let t=e=>{e.map?.dispose(),e.uniforms&&Object.values(e.uniforms).forEach(e=>{e.value?.dispose?.()}),e.dispose()};e.traverse(n=>{n.geometry?.dispose(),n.material&&(Array.isArray(n.material)?n.material.forEach(e=>{t(e)}):t(n.material)),n instanceof Mt||n.dispose?.(),n!==e&&this.cleanScene(n)})}},nf=class extends Yr{constructor(){super(...arguments),this._abortController=new AbortController}abort(){return this._abortController.abort(),this._abortController=new AbortController,this}load(e,t,n,r){let i=this._abortController.signal,a=super.load(e,e=>{s(),t(e)},n,e=>{if(s(),i.aborted){let e=Error();e.name=`AbortError`,e.message=`The operation was aborted.`,r(e)}else r(e)});function o(){a.src=``}function s(){i.removeEventListener(`abort`,o,!1)}return i.addEventListener(`abort`,o,!1),a}},rf=class extends Ud{constructor(e){super(e),this.fileLoader=new qr,this.fileLoader.setResponseType(`blob`),this.imageLoader=new nf}destroy(){this.abortLoading(),super.destroy()}abortLoading(){this.fileLoader.abort?.(),this.imageLoader.abort()}loadFile(e,t,n){let r=Pd.get(e,n);if(r){if(r instanceof Blob)return t?.(100),Promise.resolve(r);Pd.remove(e,n)}this.config.requestHeaders&&this.fileLoader.setRequestHeader(this.config.requestHeaders(e)),this.fileLoader.setWithCredentials(this.config.withCredentials(e));let i=0;return t?.(i),this.fileLoader.loadAsync(e,e=>{if(e.lengthComputable){let n=e.loaded/e.total*100;n>i&&(i=n,t?.(i))}}).then(r=>(i=100,t?.(i),Pd.add(e,n,r),r))}loadImage(e,t,n){let r=Pd.get(e,n);return r?(t?.(100),r instanceof Blob?this.blobToImage(r):Promise.resolve(r)):!t&&!this.config.requestHeaders?(this.imageLoader.setWithCredentials(this.config.withCredentials(e)),this.imageLoader.loadAsync(e).then(t=>(Pd.add(e,n,t),t))):this.loadFile(e,t,n).then(e=>this.blobToImage(e))}blobToImage(e){return new Promise((t,n)=>{let r=document.createElement(`img`);r.onload=()=>{URL.revokeObjectURL(r.src),t(r)},r.onerror=n,r.src=URL.createObjectURL(e)})}preloadPanorama(e){return this.viewer.adapter.supportsPreload(e)?this.viewer.adapter.loadTexture(e,!1):Promise.reject(new $(`Current adapter does not support preload`))}dispatchProgress(e){this.viewer.loader.setProgress(e),this.viewer.dispatchEvent(new lu(Math.round(e)))}},af=class extends Ud{constructor(e){super(e),this.zoom=new kl(e=>{this.viewer.state.vFov=this.viewer.dataHelper.zoomLevelToFov(e),this.viewer.state.hFov=this.viewer.dataHelper.vFovToHFov(this.viewer.state.vFov),this.viewer.dispatchEvent(new zu(e))},{defaultValue:this.viewer.config.defaultZoomLvl,min:0,max:100,wrap:!1}),this.position=new Al(e=>{this.viewer.dataHelper.sphericalCoordsToVector3(e,this.viewer.state.direction),this.viewer.dispatchEvent(new yu(e))},{yaw:new kl(null,{defaultValue:this.config.defaultYaw,min:0,max:2*Math.PI,wrap:!0}),pitch:new kl(null,{defaultValue:this.config.defaultPitch,min:-Math.PI/2,max:Math.PI/2,wrap:!1})}),this.roll=new kl(e=>{this.viewer.state.roll=e,this.viewer.dispatchEvent(new xu(e))},{defaultValue:0,min:-Math.PI,max:Math.PI,wrap:!1}),this.updateSpeeds()}updateSpeeds(){this.zoom.setSpeed(this.config.zoomSpeed*50),this.position.setSpeed(B.degToRad(this.config.moveSpeed*50)),this.roll.setSpeed(B.degToRad(this.config.moveSpeed*50))}update(e){this.zoom.update(e),this.position.update(e),this.roll.update(e)}},of=class{constructor(){this.ready=!1,this.needsUpdate=!1,this.continuousUpdateCount=0,this.keyboardEnabled=!1,this.direction=new H(0,0,cc),this.roll=0,this.vFov=60,this.hFov=60,this.aspect=1,this.animation=null,this.transitionAnimation=null,this.loadingPromise=null,this.idleTime=-1,this.objectsObservers={},this.size={width:0,height:0}}},sf=class extends Il{constructor(e){if(super(),this.plugins={},this.children=[],this.parent=wc(e.container),!this.parent)throw new $(`"container" element not found.`);this.parent[lc]=this,this.container=document.createElement(`div`),this.container.classList.add(`psv-container`),this.parent.appendChild(this.container),_l(this.parent),hl(this.container,`core`),this.state=new of,this.config=Od(e),this.__setSize(this.config.size),this.overlay=new Ld(this);try{bl.load()}catch(e){console.error(e),this.showError(this.config.lang.webglError);return}Pd.init(),this.adapter=new this.config.adapter[0](this,this.config.adapter[1]),this.renderer=new tf(this),this.textureLoader=new rf(this),this.eventsHandler=new Zd(this),this.dataHelper=new Kd(this),this.dynamics=new af(this),this.adapter.init?.(),this.loader=new Fd(this),this.navbar=new Nd(this),this.panel=new Bd(this),this.notification=new Id(this),this.autoSize(),this.setCursor(null),Xc(bl.isTouchEnabled,e=>{Tc(this.container,`psv--is-touch`,e)}),this.config.plugins.forEach(([e,t])=>{this.plugins[e.id]=new e(this,t)});for(let e of Object.values(this.plugins))e.init?.();this.config.navbar&&this.navbar.setButtons(this.config.navbar),this.state.loadingPromise||(this.config.panorama?this.setPanorama(this.config.panorama,{sphereCorrection:this.config.sphereCorrection,panoData:this.config.panoData}):this.loader.show())}destroy(){this.stopAll(),this.stopKeyboardControl(),this.exitFullscreen();for(let[e,t]of Object.entries(this.plugins))t.destroy(),delete this.plugins[e];this.children.slice().forEach(e=>e.destroy()),this.children.length=0,this.eventsHandler?.destroy(),this.renderer?.destroy(),this.textureLoader?.destroy(),this.dataHelper?.destroy(),this.adapter?.destroy(),this.dynamics?.destroy(),this.parent.removeChild(this.container),delete this.parent[lc]}init(){this.eventsHandler.init(),this.renderer.init(),this.config.navbar&&this.navbar.show(),this.config.keyboard===`always`&&this.startKeyboardControl(),this.resetIdleTimer(),this.state.ready=!0,this.dispatchEvent(new Cu)}resetIdleTimer(){this.state.idleTime=performance.now()}disableIdleTimer(){this.state.idleTime=-1}getPlugin(e){if(typeof e==`string`)return this.plugins[e];{let t=wd(e);return t?this.plugins[t.id]:null}}getPosition(){return this.dataHelper.cleanPosition(this.dynamics.position.current)}getZoomLevel(){return this.dynamics.zoom.current}getSize(){return{...this.state.size}}isFullscreenEnabled(){return Ic(this.parent,bl.isIphone)}needsUpdate(){this.state.needsUpdate=!0}needsContinuousUpdate(e){e?this.state.continuousUpdateCount++:this.state.continuousUpdateCount>0&&this.state.continuousUpdateCount--}autoSize(){(this.container.clientWidth!==this.state.size.width||this.container.clientHeight!==this.state.size.height)&&(this.state.size.width=Math.round(this.container.clientWidth),this.state.size.height=Math.round(this.container.clientHeight),this.state.aspect=this.state.size.width/this.state.size.height,this.state.hFov=this.dataHelper.vFovToHFov(this.state.vFov),this.dispatchEvent(new Fu(this.getSize())),this.navbar.autoSize())}setPanorama(e,t={}){this.textureLoader.abortLoading(),this.state.transitionAnimation?.cancel();let n=this.dataHelper.getTransitionOptions(t);t.showLoader===void 0&&(t.showLoader=!0),t.caption===void 0&&(t.caption=this.config.caption),t.description===void 0&&(t.description=this.config.description),!t.panoData&&typeof this.config.panoData==`function`&&(t.panoData=this.config.panoData),t.sphereCorrection===void 0&&(t.sphereCorrection=this.config.sphereCorrection),this.hideError(),this.resetIdleTimer(),this.config.panorama=e,this.config.caption=t.caption,this.config.description=t.description,this.config.sphereCorrection=t.sphereCorrection,(typeof this.config.panoData!=`function`||typeof t.panoData==`function`)&&(this.config.panoData=t.panoData);let r=t=>{if($c(t))return!1;if(this.loader.hide(),this.state.loadingPromise=null,t)throw this.navbar.setCaption(null),this.showError(this.config.lang.loadError),console.error(t),this.dispatchEvent(new hu(e,t)),t;return this.navbar.setCaption(this.config.caption),!0};this.navbar.setCaption(`<em>${this.config.lang.loading}</em>`),(t.showLoader||!this.state.ready)&&this.loader.show(),this.dispatchEvent(new du(e));let i=this.adapter.loadTexture(this.config.panorama,!0,t.panoData).then(e=>{if(e.panorama!==this.config.panorama)throw this.adapter.disposeTexture(e),Qc();let n=this.dataHelper.cleanPanoramaOptions(t,e.panoData);return(!Kc(n.zoom)||!Kc(n.position))&&this.stopAll(),{textureData:e,cleanOptions:n}});return!n||!this.state.ready||!this.adapter.supportsTransition(this.config.panorama)?this.state.loadingPromise=i.then(({textureData:e,cleanOptions:n})=>{this.renderer.show(),this.renderer.setTexture(e),this.renderer.setPanoramaPose(e.panoData),this.renderer.setSphereCorrection(t.sphereCorrection),this.state.ready||this.init(),this.dispatchEvent(new pu(e)),Kc(n.zoom)||this.zoom(n.zoom),Kc(n.position)||this.rotate(n.position)}).then(()=>r(),e=>r(e)):this.state.loadingPromise=i.then(({textureData:e,cleanOptions:t})=>(this.loader.hide(),this.dispatchEvent(new pu(e)),this.state.transitionAnimation=this.renderer.transition(e,t,n),this.state.transitionAnimation)).then(e=>{if(this.state.transitionAnimation=null,this.dispatchEvent(new _u(e)),!e)throw Qc()}).then(()=>r(),e=>r(e)),this.state.loadingPromise}setOptions(e){let t={...this.config,...e};for(let[n,r]of Object.entries(e)){if(!(n in Td)){el(`Unknown option ${n}`);continue}if(n in Ed){el(Ed[n]);continue}switch(n in Dd&&(r=Dd[n](r,{rawConfig:t,defValue:Td[n]})),this.config[n]=r,n){case`mousemove`:this.state.cursorOverride||this.setCursor(null);break;case`caption`:this.navbar.setCaption(this.config.caption);break;case`size`:this.resize(this.config.size);break;case`sphereCorrection`:this.renderer.setSphereCorrection(this.config.sphereCorrection);break;case`navbar`:case`lang`:this.navbar.setButtons(this.config.navbar);break;case`moveSpeed`:case`zoomSpeed`:this.dynamics.updateSpeeds();break;case`minFov`:case`maxFov`:this.dynamics.zoom.setValue(this.dataHelper.fovToZoomLevel(this.state.vFov)),this.dispatchEvent(new zu(this.getZoomLevel()));break;case`keyboard`:this.config.keyboard===`always`?this.startKeyboardControl():this.stopKeyboardControl();break;default:break}}this.needsUpdate(),this.dispatchEvent(new ql(Object.keys(e)))}setOption(e,t){this.setOptions({[e]:t})}showError(e){this.overlay.show({id:fc.ERROR,image:Hd,title:e,dismissible:!1})}hideError(){this.overlay.hide(fc.ERROR)}rotate(e){let t=new Ul(this.dataHelper.cleanPosition(e));this.dispatchEvent(t),!t.defaultPrevented&&this.dynamics.position.setValue(t.position)}zoom(e){this.dynamics.zoom.setValue(e)}zoomIn(e=1){this.dynamics.zoom.step(e)}zoomOut(e=1){this.dynamics.zoom.step(-e)}animate(e){let t=tl(e),n=!Kc(e.zoom),r=new zl(t?this.dataHelper.cleanPosition(e):void 0,e.zoom);if(this.dispatchEvent(r),r.defaultPrevented)return;this.stopAll();let{duration:i,properties:a}=this.dataHelper.getAnimationProperties(e.speed,r.position,r.zoomLevel);return i?(this.state.animation=new Ol({properties:a,duration:i,easing:e.easing||`inOutSine`,onTick:e=>{t&&this.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),n&&this.dynamics.zoom.setValue(e.zoom)}}),this.state.animation.then(()=>{this.state.animation=null,this.resetIdleTimer()}),this.state.animation):(t&&this.rotate(r.position),n&&this.zoom(r.zoomLevel),new Ol(null))}stopAnimation(){return this.state.animation?(this.state.animation.cancel(),this.state.animation):Promise.resolve()}resize(e){this.__setSize(e),this.autoSize()}__setSize(e){[`width`,`height`].forEach(t=>{e?.[t]&&(/^[0-9.]+$/.test(e[t])&&(e[t]+=`px`),this.parent.style[t]=e[t])})}enterFullscreen(){this.isFullscreenEnabled()||Lc(this.parent,bl.isIphone)}exitFullscreen(){this.isFullscreenEnabled()&&Rc(bl.isIphone)}toggleFullscreen(){this.isFullscreenEnabled()?this.exitFullscreen():this.enterFullscreen()}startKeyboardControl(){this.state.keyboardEnabled=!0}stopKeyboardControl(){this.state.keyboardEnabled=!1}createTooltip(e){return new Vd(this,e)}setCursor(e){this.state.cursorOverride=e,e?this.container.style.cursor=e:this.container.style.cursor=this.config.mousemove?`move`:`default`}observeObjects(e){this.state.objectsObservers[e]||(this.state.objectsObservers[e]=null)}unobserveObjects(e){delete this.state.objectsObservers[e]}stopAll(){return this.dispatchEvent(new Lu),this.disableIdleTimer(),this.stopAnimation()}},cf=`5.15.1`;export{qu as AbstractAdapter,id as AbstractButton,nd as AbstractComponent,Cd as AbstractConfigurablePlugin,Sd as AbstractPlugin,Ks as CONSTANTS,Pd as Cache,Td as DEFAULTS,td as DualFisheyeAdapter,$u as EquirectangularAdapter,$ as PSVError,bl as SYSTEM,Fl as TypedEvent,cf as VERSION,sf as Viewer,Pl as events,Md as registerButton,gc as utils};