(function () {
  function randStr(e, t) {
    for (
      var n = "",
        r = t || "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",
        o = 0;
      o < e;
      o++
    )
  ...
  function generateContent() {
    return (
      void 0 === generateContent.val &&
        (generateContent.val =
          "document.dispatchEvent(" + randStr(4 * Math.random() + 3) + ");"),
      generateContent.val
    );
  }
  try {
      ...
      Object.querySelectorAll =
        function (e, o, t, n, i) {
          ...
          for (
            ...
            for (a.addRule(e[t], "k:v"), n = i.length; n--;)
              i[n].currentStyle.k && o.push(i[n]);
            a.removeRule(0);
          }
          return o;
        });
  var popMagic = {
    ...
    isAdsDomainLicensed: function () {
      for (
        var e = this.config.ads_host,
          o = this.remoteLicensedDomains.concat([
            ".local",
            "localhost",
            "127.0.0.1",
          ]),
        ...
        if ("string" == typeof n)
          if ("." === n.charAt(0)) {
            var i = n,
              r = n.substring(1);
            if (e.slice(-i.length) === i || e === r) return !0;
          } else {
            var a = e === n,
              c = "." + n,
              p = e.slice(-c.length) === c;
            if (a || p) return !0;
          }
      }
      return !1;
    ...
    init: function (e) {
      if (void 0 !== e.idzone && e.idzone) {
        ...
        if (void 0 !== this.config.idzone && "" !== this.config.idzone) {
          !0 !== this.config.only_inline &&
            this.isAdsDomainLicensed() &&
            this.loadHosted();
          var n = this;
          this.checkTCFConsent(function () {
            "complete" === document.readyState || "interactive" === document.readyState
              ? n.preparePopWait()
              : n.addEventToElement(window, "load", n.preparePop);
          });
        }
      }
    },
    ...
    shouldShow: function (e) {
      if (window.disablePopunder) return !1;
      if (((e = e || !1), !popMagic.config.capping_enabled)) {
        var o = !0,
          t = popMagic.config.should_fire;
        try {
          e || "function" != typeof t || (o = Boolean(t()));
        } catch (e) {
      ...
      if (
        ...
        if (
          ...
          var o =
            ...
            "/venor.php?cookieconsent=" +
            popMagic.config.cookieconsent;
          (e.open("GET", popMagic.addNuvtValueToUrl(o), !0),
            (e.withCredentials = !0));
          try {
            e.send();
          } catch (e) {
    ...
    buildUrl: function () {
      ...
      var r =
        this.tcfData &&
        this.tcfData.gdprApplies &&
        !0 === this.tcfData.gdprApplies
          ? 1
          : 0;
      ((this.url =
        o +
        ...
        "&tags=" +
        this.config.tags +
        ("" !== this.config.block_ad_types
          ? "&block_ad_types=" + this.config.block_ad_types
          : "") +
        "&scr_info=" +
        (function (e) {
        ...
        this.tcfData && this.tcfData.tcString
          ? (this.url +=
              "&gdpr_consent=" + encodeURIComponent(this.tcfData.tcString))
          : (this.url += "&cookieconsent=" + this.config.cookieconsent));
    },
    addSuvtValueToUrl: function (e) {
      var o = popMagic.getCookie("__suvt");
      if (o) {
        var t = -1 !== e.indexOf("?") ? "&" : "?";
        return e + t + "suvt=" + o;
      }
    ...
    addNuvtValueToUrl: function (e) {
      var o = popMagic.getCookie("__nuvt");
      if (o) {
        var t = -1 !== e.indexOf("?") ? "&" : "?";
        return e + t + "nuvt=" + encodeURIComponent(o);
      }
      return e;
    },
    isAgegoEnabled: function () {
      return (
        "undefined" != typeof Promise &&
        void 0 !== window.AGEGO &&
        !0 === this.config.agego_cross_site_enabled
      );
    },
    prefetchAgToken: function () {
      if (popMagic.isAgegoEnabled())
        try {
          window.AGEGO("prefetchToken");
        } catch (e) {}
    },
    addAgeGoToken: function (e) {
      if (!popMagic.isAgegoEnabled()) return Promise.resolve(e);
      try {
        var o = window.AGEGO("getTokenUrl", e);
        return o && "function" == typeof o.then ? o : Promise.resolve(e);
      } catch (o) {
      ...
      if ("3" != popMagic.config.trigger_method)
        if (
          ...
          if (
            ...
            if (
              "5" != popMagic.config.trigger_method ||
              "" == popMagic.config.trigger_class
            )
          ...
          for (
            t = document.querySelectorAll(a.join(", ")), i = 0;
            i < t.length;
            i++
          )
            popMagic.addEventToElement(t[i], e, o);
    ...
    setCookie: function (e, o, t) {
      ...
      t = parseInt(t, 10);
      var n = new Date();
      n.setMinutes(n.getMinutes() + parseInt(t));
      var i =
        encodeURIComponent(o) + "; expires=" + n.toUTCString() + "; path=/";
      document.cookie = e + "=" + i;
    },
    getCookie: function (e) {
      ...
      for (o = 0; o < i.length; o++)
        if (
          ((t = i[o].substr(0, i[o].indexOf("="))),
          (n = i[o].substr(i[o].indexOf("=") + 1)),
          (t = t.replace(/^\s+|\s+$/g, "")) === e)
        )
    ...
    findLinkToOpen: function (e) {
      ...
      try {
        ...
        (i && -1 !== i.indexOf("_blank")) || (t = o.getAttribute("href"));
      } catch (e) {}
    ...
    browserDetector: {
      ...
      isChromeOrChromium: function () {
        ...
        if (
          e.userAgentData &&
          Array.isArray(e.userAgentData.brands) &&
          e.userAgentData.brands.length > 0
        ) {
          var n = e.userAgentData.brands,
            i = n.some(function (e) {
        ...
        var a = !!window.chrome,
          ...
          d = -1 !== o.indexOf("yabrowser"),
          l = -1 !== o.indexOf("samsungbrowser"),
          u = -1 !== o.indexOf("ucbrowser");
        return (
          a && "Google Inc." === t && !c && !p && !s && !g && !d && !l && !u
        );
      },
      getBrowserInfo: function () {
        ...
        for (var t in this.browserDefinitions) {
          var n = this.browserDefinitions[t];
          if (n[1].test(e)) {
            var i = n[1].exec(e),
              r = i && i[1].split(/[._]/).slice(0, 3),
